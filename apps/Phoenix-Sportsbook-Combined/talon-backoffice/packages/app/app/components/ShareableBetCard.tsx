...
export async function copyBetCardToClipboard(data: BetCardData): Promise<boolean> {
  try {
    ...
    logger.error('ShareableBetCard', 'Failed to copy bet card to clipboard', message);
    return false;
  }
}
