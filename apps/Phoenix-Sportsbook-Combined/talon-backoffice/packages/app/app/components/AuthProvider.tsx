...
import { login as authLogin, refresh as authRefresh } from '../lib/api/auth-client';
  ...
  useEffect(() => {
    try {
      if (apiClient.isAuthenticated()) {
        ...
        const userId = typeof window !== 'undefined' ? localStorage.getItem('phoenix_user_id') : null;
        const username = typeof window !== 'undefined' ? localStorage.getItem('phoenix_username') : null;
        if (userId && username) {
