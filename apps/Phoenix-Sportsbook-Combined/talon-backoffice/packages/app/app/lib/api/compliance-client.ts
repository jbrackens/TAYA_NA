 ...
 */
export async function setDepositLimits(request: SetDepositLimitsRequest): Promise<DepositLimits> {
  const raw = await apiClient.post<DepositLimitsRaw>('/api/v1/punters/deposit-limits', request);
 ...
 */
export async function setStakeLimits(request: SetStakeLimitsRequest): Promise<StakeLimits> {
  const raw = await apiClient.post<StakeLimitsRaw>('/api/v1/punters/stake-limits', request);
  return normalizeSnakeCase(raw);
}
 ...
 */
export async function setSessionLimits(request: SetSessionLimitsRequest): Promise<SessionLimits> {
  const raw = await apiClient.post<SessionLimitsRaw>('/api/v1/punters/session-limits', request);
  return normalizeSnakeCase(raw);
}
 ...
 */
export async function coolOff(request: CoolOffRequest): Promise<CoolOffResponse> {
  const raw = await apiClient.post<CoolOffResponseRaw>('/api/v1/punters/cool-off', request);
  return normalizeSnakeCase(raw);
}
 ...
 */
export async function selfExclude(request: SelfExcludeRequest): Promise<SelfExcludeResponse> {
  const raw = await apiClient.post<SelfExcludeResponseRaw>('/api/v1/punters/self-exclude', request);
  return normalizeSnakeCase(raw);
}
 ...
 */
export async function getLimitsHistory(userId: string): Promise<GetLimitsHistoryResponse> {
  const raw = await apiClient.get<GetLimitsHistoryResponseRaw>('/api/v1/punters/limits-history', {
    user_id: userId
  });
  return normalizeSnakeCase(raw);
}
