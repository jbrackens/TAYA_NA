...
import AdminFixedExotics from "../controllers/admin/fixedExoticsController";
import AdminPrediction from "../controllers/admin/predictionController";
...
export default () => {
  ...
  api.get("/prediction/summary", AdminPrediction.summary);

  // GET /prediction/markets
  api.get("/prediction/markets", AdminPrediction.markets);

  // GET /prediction/markets/:id
  api.get("/prediction/markets/:id", AdminPrediction.details);

  // GET /prediction/markets/:id/lifecycle
  api.get("/prediction/markets/:id/lifecycle", AdminPrediction.lifecycleHistory);

  // GET /prediction/orders
  api.get("/prediction/orders", AdminPrediction.orders);

  // GET /prediction/orders/:id
  api.get("/prediction/orders/:id", AdminPrediction.orderDetails);

  // POST /prediction/markets/:id/lifecycle/:action
  api.post(
    "/prediction/markets/:id/lifecycle/:action",
    AdminPrediction.lifecycle,
  );

  // GET /exotics/fixed/quotes
  api.get("/exotics/fixed/quotes", AdminFixedExotics.list);

  // GET /exotics/fixed/quotes/:id
  api.get("/exotics/fixed/quotes/:id", AdminFixedExotics.details);

  // POST /exotics/fixed/quotes/:id/lifecycle/expire
  api.post(
    "/exotics/fixed/quotes/:id/lifecycle/expire",
    AdminFixedExotics.expire,
  );
