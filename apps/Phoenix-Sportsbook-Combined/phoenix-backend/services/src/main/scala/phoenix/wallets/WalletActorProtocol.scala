...
object WalletActorProtocol {
  ...
  object commands {
    ...
    final case class ReserveFundsForPrediction(walletId: WalletId, bet: Bet, replyTo: ActorRef[WalletResponse])
        extends ActiveWalletCommand
    ...
    final case class MarkPredictionVoided(
        walletId: WalletId,
        reservationId: ReservationId,
        replyTo: ActorRef[WalletResponse])
        extends ActiveWalletCommand
    ...
    final case class MarkPredictionPushed(
        walletId: WalletId,
        reservationId: ReservationId,
        replyTo: ActorRef[WalletResponse])
        extends ActiveWalletCommand
    ...
    final case class MarkPredictionCancelled(
        walletId: WalletId,
        reservationId: ReservationId,
        replyTo: ActorRef[WalletResponse])
        extends ActiveWalletCommand
    ...
    final case class MarkPredictionWon(
        walletId: WalletId,
        reservationId: ReservationId,
        replyTo: ActorRef[WalletResponse])
        extends ActiveWalletCommand
    ...
    final case class MarkPredictionLost(
        walletId: WalletId,
        reservationId: ReservationId,
        replyTo: ActorRef[WalletResponse])
        extends ActiveWalletCommand
    ...
    final case class ResettlePrediction(
        walletId: WalletId,
        bet: Bet,
        winner: Boolean,
        replyTo: ActorRef[WalletResponse])
  ...
  object events {
    ...
    final case class FundsReservedForPrediction(
        walletId: WalletId,
        reservationId: ReservationId,
        bet: Bet,
        previousBalance: AccountBalance,
      ...
      override def transaction: Transaction =
        BetTransaction(
          transactionId = reservationId.unwrap,
          reason = TransactionReason.FundsReservedForPrediction,
          amount = bet.stake.moneyAmount,
          previousBalance = previousBalance,
          bet = bet,
          timestamp = createdAt)
    ...
    final case class PredictionVoided(
        walletId: WalletId,
        reservationId: ReservationId,
        bet: Bet,
        previousBalance: AccountBalance,
      ...
      override def transaction: Transaction =
        BetTransaction(
          transactionId = reservationId.unwrap,
          reason = TransactionReason.PredictionVoided,
          amount = bet.stake.moneyAmount,
          previousBalance = previousBalance,
          bet = bet,
          timestamp = createdAt)
    ...
    final case class PredictionPushed(
        walletId: WalletId,
        reservationId: ReservationId,
        bet: Bet,
        previousBalance: AccountBalance,
      ...
      override def transaction: Transaction =
        BetTransaction(
          transactionId = reservationId.unwrap,
          reason = TransactionReason.PredictionPushed,
          amount = bet.stake.moneyAmount,
          previousBalance = previousBalance,
          bet = bet,
          timestamp = createdAt)
    ...
    final case class PredictionCancelled(
        walletId: WalletId,
        reservationId: ReservationId,
        bet: Bet,
        previousBalance: AccountBalance,
      ...
      override def transaction: Transaction =
        BetTransaction(
          transactionId = reservationId.unwrap,
          reason = TransactionReason.PredictionCancelled,
          amount = bet.stake.moneyAmount,
          previousBalance = previousBalance,
          bet = bet,
          timestamp = createdAt)
    ...
    final case class PredictionWon(
        walletId: WalletId,
        reservationId: ReservationId,
        bet: Bet,
        previousBalance: AccountBalance,
      ...
      override def transaction: Transaction =
        BetTransaction(
          transactionId = reservationId.unwrap,
          reason = TransactionReason.PredictionWon,
          amount = bet.winnerFunds.moneyAmount,
          previousBalance = previousBalance,
          bet = bet,
          timestamp = createdAt)
    ...
    final case class PredictionLost(
        walletId: WalletId,
        reservationId: ReservationId,
        bet: Bet,
        previousBalance: AccountBalance,
      ...
      override def transaction: Transaction =
        BetTransaction(
          transactionId = reservationId.unwrap,
          reason = TransactionReason.PredictionLost,
          amount = bet.stake.moneyAmount,
          previousBalance = previousBalance,
          bet = bet,
          timestamp = createdAt)
    ...
    final case class PredictionResettled(
        walletId: WalletId,
        transactionId: TransactionId,
        bet: Bet,
        winner: Boolean,
