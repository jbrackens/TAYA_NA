...
| wallet reservation after place | pass | balance moved from `958.00` to `947.00` |
...
| order resettlement context | pass | order `po-1841c38f-a01f-47f4-bffc-b0f7fa057e69` moved to `resettled` with previous status `won` |
| punter wallet balance after resettle | pass | wallet balance reachable after settlement correction |
| wallet reconciliation after resettle | pass | balance corrected to `947.00` after resettlement |
| punter wallet history | pass | wallet transaction history reachable |
| punter wallet history | pass | wallet transaction history reachable |
| punter wallet history | pass | wallet transaction history reachable |
| prediction wallet descriptors | pass | wallet history carries product and prior-settlement context for `po-1841c38f-a01f-47f4-bffc-b0f7fa057e69` |
