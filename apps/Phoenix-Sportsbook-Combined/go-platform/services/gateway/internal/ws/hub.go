...
// NotifyMarketUpdate broadcasts a market update event
func (h *Hub) NotifyMarketUpdate(fixtureID string, data interface{}) {
	h.BroadcastEvent("markets:"+fixtureID, "market_update", "market_update", data)
}

// NotifyFixtureUpdate broadcasts a fixture update event
func (h *Hub) NotifyFixtureUpdate(sportKey string, data interface{}) {
	h.BroadcastEvent("fixtures:"+sportKey, "fixture_update", "fixture_update", data)
}

// NotifyBetUpdate broadcasts a bet update event
func (h *Hub) NotifyBetUpdate(userID string, data interface{}) {
	h.BroadcastEvent("bets:"+userID, "bet_update", "bet_update", data)
}

// NotifyWalletUpdate broadcasts a wallet update event
