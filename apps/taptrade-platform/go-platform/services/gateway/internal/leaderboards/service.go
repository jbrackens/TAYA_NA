...
func NewService() *Service {
	...
	profit, _ := svc.CreateDefinition(CreateDefinitionRequest{
		...
		Currency:       "PTS",
		PrizeSummary:   "Top 10 earn leaderboard status and XP boosts.",
	...
	staking, _ := svc.CreateDefinition(CreateDefinitionRequest{
		...
		Status:         canonicalv1.LeaderboardStatusActive,
		Currency:       "PTS",
		PrizeSummary:   "Top 25 earn VIP progress boosts.",
		WindowStartsAt: &weeklyStart,
		WindowEndsAt:   &weeklyEnd,
		CreatedBy:      "system",
	})
	referrals, _ := svc.CreateDefinition(CreateDefinitionRequest{
		...
		Order:          canonicalv1.LeaderboardOrderDescending,
		Status:         canonicalv1.LeaderboardStatusActive,
		PrizeSummary:   "Top referrers unlock non-redeemable campaign rewards.",
		WindowStartsAt: &weeklyStart,
		WindowEndsAt:   &weeklyEnd,
		CreatedBy:      "system",
	})
	...
	lastWeekProfit, _ := svc.CreateDefinition(CreateDefinitionRequest{
		...
		Status:         canonicalv1.LeaderboardStatusActive,
		Currency:       "PTS",
		PrizeSummary:   "Top 10 earned leaderboard status and XP boosts.",
	...
	_, _ = svc.CreateDefinition(CreateDefinitionRequest{
		...
		Currency:       "PTS",
		PrizeSummary:   "Top 5 earn non-redeemable VIP status boosts.",
