	...
	res, err := db.Exec(`
		...
		VALUES
		  ...
		  (md5('audit-demo-3')::uuid,
		   ...
		   'success',
		   '{"demo":true,"result":"yes","market_ticker":"SENATE-DEM-2026","settlementPoints":487200}',
		   '10.0.0.1',
		   'Go-SeedAdmin/1.0',
		   NOW() - INTERVAL '4 days'),
		  ...
		  (md5('audit-demo-4')::uuid,
		   ...
		   'success',
		   '{"demo":true,"result":"no","market_ticker":"GPT5-JUL26","settlementPoints":195000}',
		   '10.0.0.1',
		   'Go-SeedAdmin/1.0',
		  ...
		  (md5('audit-demo-7')::uuid,
		   ...
		   'success',
		   '{"demo":true,"market_ticker":"UCL-CITY-2526","yesPricePoints":38,"execution_mode":"order_book"}',
		   '172.16.0.5',
		   'BackofficeApp/3.1 (admin-panel)',
		   NOW() - INTERVAL '5 days'),
