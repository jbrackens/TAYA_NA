...
function PredictionCategoryPage(props: PageProps) {
  return <Components.Pages.Prediction {...props} view="category" />;
}

PredictionCategoryPage.getInitialProps = async () => ({
  namespacesRequired: Components.Pages.Prediction.namespacesRequired,
  layoutVariant: "prediction-redesign",
});

export default PredictionCategoryPage;
