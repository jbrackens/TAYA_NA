...
import { useForgotPassword } from "../../../../services/go-api";
...
export const ForgotResetPasswordModalComponent: React.FC<ForgotResetPasswordModalComponent> = ({
  ...
  const error = forgotPasswordMutation.error as AppError | undefined;
  ...
  return (
    ...
    >
      ...
      >
        ...
        {(forgotPasswordMutation.isLoading || error) && (
          <Row
            justify="center"
            align="middle"
            gutter={[32, 32]}
            role={forgotPasswordMutation.isLoading ? "loading" : "error"}
          >
            {error && (
              <Col span={24}>
                <ErrorComponent
