    ...
    <div className="mx-auto grid w-full max-w-[1920px] grid-cols-[150px_minmax(0,1fr)_340px] items-start gap-0 bg-[var(--bg-deep)] max-[1179px]:grid-cols-[150px_minmax(0,1fr)] max-[1023px]:grid-cols-1">
      ...
      >
        <span
          ...
          aria-current="page"
        >
          <span className="h-[13px] w-[3px] flex-none rounded-[1px] bg-[var(--accent)]" />
        ...
        >
          <span className="h-[13px] w-[3px] flex-none rounded-[1px] bg-[var(--border-2)]" />
          {t("FLOOR_NAV_BOOK", "My Book")}
        </Link>
        <Link
          href="/leaderboards"
          className={`${NAV_ITEM_CLASS} text-[var(--t3)] hover:bg-[var(--surface-2)] hover:text-[var(--t1)]`}
