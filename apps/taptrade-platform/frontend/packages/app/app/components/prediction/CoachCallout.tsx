 ...
 * (Figma: 02 System → Coach/Callout). Lime-wash = action voice. Always
...
const WRAP_CLASS =
  "flex w-full items-start gap-2 rounded-[var(--radius-md)] border border-[var(--lime-text)] bg-[var(--lime-wash)] px-3 py-2.5";
const ADVANCE_CLASS =
  "flex min-w-0 flex-1 cursor-pointer items-start gap-2.5 border-0 bg-transparent p-0 text-left";
const DOT_CLASS =
  "mt-[3px] h-2 w-2 shrink-0 rounded-full bg-[var(--lime-text)]";
