  ...
  def handle(responsibilityCheckTaskRepository: ResponsibilityCheckTaskRepository, uuidGenerator: UUIDGenerator)(
    ...
    event match {
      ...
      case _: WalletCreated | _: AdjustingFundsDeposited | _: AdjustingFundsWithdrawn | _: FundsDeposited |
          _: FundsReservedForBet | _: FundsReservedForPrediction | _: FundsReservedForWithdrawal | _: FundsWithdrawn |
          _: ResponsibilityCheckAcceptanceRequested | _: WithdrawalCancelled | _: WithdrawalConfirmed | _: BetWon |
          _: BetVoided | _: BetResettled | _: BetCancelled | _: BetLost | _: BetPushed | _: PredictionWon |
          _: PredictionVoided | _: PredictionResettled | _: PredictionCancelled | _: PredictionLost |
          _: PredictionPushed | _: PunterUnsuspendApproved | _: PunterUnsuspendRejected | _: NegativeBalance =>
        Future.unit
    }
}
