      ...
      Seq[ReportTable](
        ReportTable(
          ...
          columns = Seq(
            ...
            Column(displayName = "Ending Prediction Exposure", aggregation = Sum),
            Column(displayName = "Patron Prediction Win/Loss", aggregation = Sum),
...
object PatronAccountSummary {
  ...
  final case class PatronAccountSummaryReportRow(
      ...
      endingPredictionExposure: MoneyField,
      patronPredictionWinLoss: MoneyField,
