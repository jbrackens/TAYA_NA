  ...
  def handle(
    ...
    event match {
      ...
      case _: FundsReservedForWithdrawal | _: AdjustingFundsDeposited | _: AdjustingFundsWithdrawn |
          ...
          _: BetCancelled | _: PredictionCancelled | _: BetLost | _: PredictionLost | _: BetPushed |
          _: PredictionPushed | _: BetResettled | _: PredictionResettled | _: BetVoided | _: PredictionVoided |
          _: BetWon | _: PredictionWon | _: FundsReservedForBet | _: FundsReservedForPrediction |
