...
- Generated: `2026-07-01T08:19:50Z`
...
|---|---:|---:|---:|---:|
| Gateway OpenAPI paths | 18 | 120 | 102 | 0 |
| Gateway handler route strings | 9 | 9 | 0 | 0 |
| Gateway route strings across core handlers | 34 | 48 | 14 | 0 |
| Phoenix API-client methods | 8 | 8 | 0 | 0 |
| Prediction API-client methods | 26 | 38 | 12 | 0 |
| Player wallet client exports | 6 | 12 | 9 | 0 |
...
- `/api/v1/wallet/{userId}/breakdown`
