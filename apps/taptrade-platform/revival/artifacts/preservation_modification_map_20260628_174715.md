...
- Generated: `2026-06-28T17:47:27Z`
...
- Modified tracked artifacts classified: `386`
- High-risk contract files: `85`
- Large-change threshold: `250` changed lines
- Large-change files: `34`
- Tracked line churn: `+30542 / -6079`
...
| high | gateway economy, rank, or compliance logic | 14 |
| high | gateway point-wallet ledger contract | 2 |
...
| medium | office admin and operations surface | 38 |
| medium | player client state and API normalization | 19 |
| medium | player launch user surface | 35 |
...
| high | gateway HTTP and admin handlers | 1315 | 56 | 1371 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_admin_handlers_test.go` |
...
| high | gateway HTTP and admin handlers | 852 | 159 | 1011 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_handlers.go` |
...
| high | gateway point-wallet ledger contract | 517 | 17 | 534 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/wallet/service.go` |
...
| high | gateway prediction engine and persistence | 431 | 9 | 440 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/types.go` |
...
| high | gateway prediction engine and persistence | 395 | 0 | 395 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/json_defaults_test.go` |
...
| high | gateway HTTP and admin handlers | 91 | 2 | 93 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_leaderboard_handlers_test.go` |
...
| high | gateway HTTP and admin handlers | 13 | 11 | 24 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_leaderboards_admin_handlers.go` |
...
| high | gateway prediction engine and persistence | 6 | 5 | 11 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/settlement.go` |
...
| low | player regression tests | 218 | 26 | 244 | `apps/Phoenix-Predict-Combined/talon-backoffice/e2e/prediction/critical-paths.api.spec.ts` |
...
| medium | gateway schema and seed data | 104 | 47 | 151 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/seed-data/seed_prediction.sql` |
...
| medium | office admin and operations surface | 26 | 10 | 36 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/app/(dashboard)/layout.tsx` |
...
| medium | verification and release governance | 44 | 29 | 73 | `apps/Phoenix-Predict-Combined/Makefile` |
...
| medium | verification and release governance | 39 | 33 | 72 | `apps/Phoenix-Predict-Combined/scripts/pre-commit-hook.sh` |
| medium | verification and release governance | 38 | 280 | 318 | `apps/Phoenix-Predict-Combined/scripts/qa/go-capability-slo-gate.sh` |
