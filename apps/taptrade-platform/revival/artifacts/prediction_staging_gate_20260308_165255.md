...
| wallet reservation after place | pass | balance moved from `936.00` to `925.00` |
...
| order resettlement context | pass | order `po-3d9bb738-605b-4dcb-a677-7582a94403b8` moved to `resettled` with previous status `won` |
| punter wallet balance after resettle | pass | wallet balance reachable after settlement correction |
| wallet reconciliation after resettle | pass | balance corrected to `925.00` after resettlement |
| punter wallet history | pass | wallet transaction history reachable |
| prediction wallet descriptors | pass | wallet history carries product and prior-settlement context for `po-3d9bb738-605b-4dcb-a677-7582a94403b8` |
...
| prediction projection reconciliation | pass | event log replay matches live prediction projection state |
