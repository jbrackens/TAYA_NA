...
- Generated: `2026-06-30T09:21:45Z`
...
- Modified tracked artifacts classified: `419`
- High-risk contract files: `99`
- Large-change threshold: `250` changed lines
- Large-change files: `37`
- Tracked line churn: `+33467 / -6717`
...
| high | gateway HTTP and admin handlers | 44 |
...
| high | gateway HTTP and admin handlers | 70 | 22 | 92 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_admin_handlers.go` |
...
| high | gateway HTTP and admin handlers | 78 | 10 | 88 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_admin_routes_test.go` |
...
| medium | verification and release governance | 84 | 30 | 114 | `apps/Phoenix-Predict-Combined/Makefile` |
