...
- Generated: `2026-06-30T10:31:52.448Z`
- Backend: `/Users/john/Sandbox/Taya_NA_Predict/Taya_Na_Predict/apps/Phoenix-Predict-Combined/phoenix-backend`
- Resolved classpath log: `/Users/john/Sandbox/Taya_NA_Predict/Taya_Na_Predict/apps/Phoenix-Predict-Combined/revival/artifacts/jvm_resolved_classpath_20260630_103139.log`
...
- Resolved package/version coordinates: **233**
- Coordinates with OSV findings: **31**
...
|---|---:|---|---|
| `ch.qos.logback:logback-core` | `1.2.13` | GHSA-25qh-j22f-pwp8<br>GHSA-6v67-2wr5-gvf4<br>GHSA-pr98-23f8-jwxv<br>GHSA-qqpg-mvqg-649v | `/Users/john/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/ch/qos/logback/logback-core/1.2.13/logback-core-1.2.13.jar` |
| `com.fasterxml.jackson.core:jackson-core` | `2.13.3` | GHSA-72hv-8253-57qq<br>GHSA-h46c-h94j-95f3 | `/Users/john/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/com/fasterxml/jackson/core/jackson-core/2.13.3/jackson-core-2.13.3.jar` |
| `com.fasterxml.jackson.core:jackson-databind` | `2.13.3` | GHSA-3wrr-7qpf-2prh<br>GHSA-5jmj-h7xm-6q6v<br>GHSA-hgj6-7826-r7m5<br>GHSA-j3rv-43j4-c7qm<br>GHSA-jjjh-jjxp-wpff<br>GHSA-rgv9-q543-rqg4<br>GHSA-rmj7-2vxq-3g9f | `/Users/john/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/com/fasterxml/jackson/core/jackson-databind/2.13.3/jackson-databind-2.13.3.jar` |
| `com.google.guava:guava` | `30.1-jre` | GHSA-5mg8-w23w-74h3<br>GHSA-7g45-4rm6-3mm3 | `/Users/john/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/com/google/guava/guava/30.1-jre/guava-30.1-jre.jar` |
...
| `commons-io:commons-io` | `2.5` | GHSA-78wr-2p64-hpwj<br>GHSA-gwrp-pvrq-jmwv | `/Users/john/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/commons-io/commons-io/2.5/commons-io-2.5.jar` |
...
| `org.apache.avro:avro` | `1.11.0` | GHSA-r7pg-v2c8-mfg3<br>GHSA-rhrv-645h-fjfh | `/Users/john/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/org/apache/avro/avro/1.11.0/avro-1.11.0.jar` |
| `org.apache.commons:commons-compress` | `1.21` | GHSA-4265-ccf5-phj5<br>GHSA-4g9r-vxhx-9pgx | `/Users/john/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/org/apache/commons/commons-compress/1.21/commons-compress-1.21.jar` |
...
| `org.apache.kafka:kafka-clients` | `3.0.0` | GHSA-2x2g-32r7-p4x8<br>GHSA-5qcv-4rpc-jp93<br>GHSA-wf66-mphr-4c4r | `/Users/john/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/org/apache/kafka/kafka-clients/3.0.0/kafka-clients-3.0.0.jar` |
...
| `org.lz4:lz4-java` | `1.7.1` | GHSA-cmp6-m4wj-q63q<br>GHSA-vqf4-7m7x-wgfc | `/Users/john/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/org/lz4/lz4-java/1.7.1/lz4-java-1.7.1.jar` |
| `org.postgresql:postgresql` | `42.2.19` | GHSA-24rp-q3w6-vc56<br>GHSA-562r-vg33-8x8h<br>GHSA-673j-qm5f-xpv8<br>GHSA-727h-hrw8-jg8q<br>GHSA-98qh-xjc8-98pq<br>GHSA-r38f-c4h4-hqq2<br>GHSA-v7wg-cpwc-24m4 | `/Users/john/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/org/postgresql/postgresql/42.2.19/postgresql-42.2.19.jar` |
...
| `org.xerial.snappy:snappy-java` | `1.1.8.1` | GHSA-55g7-9cwv-5qfv<br>GHSA-fjpj-2g6w-x25r<br>GHSA-pqr6-cmr2-h8hf<br>GHSA-qcwq-55hx-v3vh | `/Users/john/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/org/xerial/snappy/snappy-java/1.1.8.1/snappy-java-1.1.8.1.jar` |
...
| `ch.qos.logback:logback-classic` | `1.2.13` | 1 |
| `ch.qos.logback:logback-core` | `1.2.13` | 1 |
...
| `com.fasterxml.jackson.core:jackson-annotations` | `2.13.3` | 1 |
| `com.fasterxml.jackson.core:jackson-core` | `2.13.3` | 1 |
| `com.fasterxml.jackson.core:jackson-databind` | `2.13.3` | 1 |
...
| `com.github.luben:zstd-jni` | `1.5.0-2` | 1 |
...
| `com.github.virtuald:curvesapi` | `1.06` | 1 |
| `com.google.code.findbugs:jsr305` | `3.0.2` | 1 |
| `com.google.errorprone:error_prone_annotations` | `2.10.0` | 1 |
| `com.google.guava:failureaccess` | `1.0.1` | 1 |
| `com.google.guava:guava` | `30.1-jre` | 1 |
| `com.google.guava:listenablefuture` | `9999.0-empty-to-avoid-conflict-with-guava` | 1 |
| `com.google.inject:guice` | `5.0.1` | 1 |
| `com.google.j2objc:j2objc-annotations` | `1.3` | 1 |
...
| `com.rabbitmq:amqp-client` | `5.8.0` | 1 |
...
| `com.squareup.okhttp3:okhttp` | `3.14.7` | 1 |
| `com.squareup.okio:okio` | `1.17.2` | 1 |
| `com.sun.activation:jakarta.activation` | `1.2.2` | 1 |
| `com.sun.istack:istack-commons-runtime` | `3.0.10` | 1 |
| `com.sun.mail:jakarta.mail` | `1.6.5` | 1 |
...
| `com.zaxxer:SparseBitSet` | `1.2` | 1 |
| `commons-beanutils:commons-beanutils` | `1.9.4` | 1 |
| `commons-codec:commons-codec` | `1.15` | 1 |
| `commons-collections:commons-collections` | `3.2.2` | 1 |
| `commons-digester:commons-digester` | `2.1` | 1 |
| `commons-io:commons-io` | `2.5` | 1 |
| `commons-net:commons-net` | `3.6` | 1 |
...
| `net.java.dev.jna:jna` | `5.9.0` | 1 |
| `net.logstash.logback:logstash-logback-encoder` | `7.2` | 1 |
| `net.oneandone.reflections8:reflections8` | `0.11.7` | 1 |
| `org.agrona:agrona` | `1.14.0` | 1 |
| `org.apache.avro:avro` | `1.11.0` | 1 |
| `org.apache.commons:commons-collections4` | `4.4` | 1 |
| `org.apache.commons:commons-compress` | `1.21` | 1 |
| `org.apache.commons:commons-lang3` | `3.12.0` | 1 |
...
| `org.apache.james:apache-mime4j` | `0.6` | 1 |
| `org.apache.kafka:kafka-clients` | `3.0.0` | 1 |
| `org.apache.poi:poi-ooxml-schemas` | `4.1.2` | 1 |
| `org.apache.poi:poi-ooxml` | `4.1.2` | 1 |
| `org.apache.poi:poi` | `4.1.2` | 1 |
| `org.apache.xmlbeans:xmlbeans` | `3.1.0` | 1 |
...
| `org.jboss.resteasy:resteasy-client` | `3.15.1.Final` | 1 |
| `org.jboss.resteasy:resteasy-jackson2-provider` | `3.15.1.Final` | 1 |
| `org.jboss.resteasy:resteasy-jaxb-provider` | `3.15.1.Final` | 1 |
| `org.jboss.resteasy:resteasy-jaxrs` | `3.15.1.Final` | 1 |
| `org.jboss.resteasy:resteasy-multipart-provider` | `3.15.1.Final` | 1 |
...
| `org.jetbrains.kotlin:kotlin-stdlib-jdk7` | `1.6.0` | 1 |
| `org.jetbrains.kotlin:kotlin-stdlib-jdk8` | `1.6.0` | 1 |
| `org.jetbrains.kotlin:kotlin-stdlib` | `1.6.0` | 1 |
| `org.jetbrains.kotlinx:kotlinx-coroutines-core` | `1.3.9` | 1 |
| `org.jline:jline` | `3.21.0` | 1 |
...
| `org.postgresql:postgresql` | `42.2.19` | 1 |
| `org.reactivestreams:reactive-streams` | `1.0.3` | 1 |
| `org.scala-lang:scala-compiler` | `2.13.8` | 1 |
| `org.scala-lang:scala-library` | `2.13.8` | 1 |
| `org.scala-lang:scala-reflect` | `2.13.8` | 1 |
...
| `org.xerial.snappy:snappy-java` | `1.1.8.1` | 1 |
