...
- Generated: `2026-07-01T07:07:52Z`
...
- Modified tracked artifacts classified: `489`
- High-risk contract files: `129`
- Large-change threshold: `250` changed lines
- Large-change files: `39`
- Tracked line churn: `+35966 / -6946`
...
| high | gateway guarded legacy transfer compatibility | 1 |
...
| high | gateway HTTP and admin handlers | 233 | 0 | 233 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/alpha_cashier_admin_handlers_test.go` |
...
| high | gateway HTTP and admin handlers | 75 | 15 | 90 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/alpha_cashier_admin_handlers.go` |
