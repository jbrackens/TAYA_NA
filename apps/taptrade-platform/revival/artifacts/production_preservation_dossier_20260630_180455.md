...
- Generated: `2026-06-30T18:04:57Z`
...
- Shortstat: ` 539 files changed, 34123 insertions(+), 14007 deletions(-)`
...
| Untracked artifacts in scope | 907 |
...
|---|---|---:|
| high | untracked gateway HTTP/admin behavior or tests | 20 |
...
| low | untracked revival evidence report | 643 |
