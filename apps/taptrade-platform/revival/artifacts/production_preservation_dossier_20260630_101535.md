...
- Generated: `2026-06-30T10:15:37Z`
...
| Untracked artifacts in scope | 678 |
...
|---|---|---|
| D | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/testdata/reconciliation/lifecycle_cases.json` | route behavior, admin authorization, request/response compatibility, unsafe copy rejection |
| D | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/testdata/seeds/read-model.seed 2.json` | route behavior, admin authorization, request/response compatibility, unsafe copy rejection |
...
| low | untracked revival evidence report | 418 |
