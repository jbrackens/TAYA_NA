...
- Generated: `2026-06-29T18:11:11Z`
...
- Shortstat: ` 466 files changed, 32781 insertions(+), 13851 deletions(-)`
...
| Untracked artifacts in scope | 560 |
...
|---|---|---:|
| high | untracked gateway HTTP/admin behavior or tests | 17 |
...
| low | untracked revival evidence report | 305 |
