...
- Generated: `2026-06-30T20:03:53Z`
...
- Modified tracked artifacts classified: `486`
- High-risk contract files: `126`
- Large-change threshold: `250` changed lines
- Large-change files: `39`
- Tracked line churn: `+35284 / -6880`
...
| high | gateway HTTP and admin handlers | 46 |
...
| high | gateway HTTP and admin handlers | 382 | 57 | 439 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/bonus_handlers.go` |
...
| high | gateway HTTP and admin handlers | 154 | 4 | 158 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/content_handlers.go` |
...
| high | gateway HTTP and admin handlers | 69 | 14 | 83 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/rbac_admin_handlers.go` |
