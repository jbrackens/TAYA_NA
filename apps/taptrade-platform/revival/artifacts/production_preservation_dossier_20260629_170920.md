...
- Generated: `2026-06-29T17:09:21Z`
...
- Shortstat: ` 466 files changed, 32278 insertions(+), 13832 deletions(-)`
...
| Gateway HTTP/admin handlers | 43 |
...
|---|---|---:|
| high | untracked gateway HTTP/admin behavior or tests | 15 |
...
| low | untracked revival evidence report | 254 |
...
| medium | untracked verification or security governance | 11 |
...
| low | untracked revival evidence report | `apps/Phoenix-Predict-Combined/revival/artifacts/production_preservation_dossier_20260629_170611.md` |
