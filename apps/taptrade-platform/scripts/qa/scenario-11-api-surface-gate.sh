...
PREDICTION_CLIENT_PATH="$ROOT/frontend/packages/api-client/src/prediction-client.ts"
API_CLIENT_PATH="$ROOT/frontend/packages/api-client/src/client.ts"
PLAYER_WALLET_CLIENT_PATH="$ROOT/frontend/packages/app/app/lib/api/wallet-client.ts"
