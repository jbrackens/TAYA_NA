...
classify_untracked_path() {
  ...
  case "$path" in
    ...
    apps/taptrade-platform/go-platform/services/gateway/internal/prediction/*)
      ...
      return 0
      ;;
    apps/taptrade-platform/go-platform/services/gateway/cmd/prediction-reconciliation-report/*)
      printf 'high\tuntracked point-reconciliation proof command'
      return 0
      ;;
    apps/taptrade-platform/go-platform/services/gateway/cmd/launch-boundary-report/*|\
apps/taptrade-platform/go-platform/services/gateway/cmd/windowed-resolution-live-proof/*)
...
apps/taptrade-platform/frontend/scripts/qa/*)
...
apps/taptrade-platform/frontend/packages/office/tests/*)
      ...
      return 0
      ;;
    apps/taptrade-platform/frontend/packages/app/app/*|\
apps/taptrade-platform/frontend/packages/app/app/components/*|\
apps/taptrade-platform/frontend/packages/app/app/lib/*|\
apps/taptrade-platform/frontend/packages/app/app/rewards/*|\
apps/taptrade-platform/frontend/packages/app/app/activity/*|\
apps/taptrade-platform/frontend/packages/app/app/series/*|\
apps/taptrade-platform/frontend/packages/app/app/users/*)
      printf 'medium\tuntracked player launch surface'
      return 0
      ;;
    apps/taptrade-platform/frontend/packages/app/public/images/markets/*)
      printf 'low\tuntracked market visual asset'
      return 0
      ;;
    apps/taptrade-platform/frontend/packages/app/translations/|\
apps/taptrade-platform/frontend/packages/app/translations/*)
...
apps/taptrade-platform/frontend/packages/office/containers/*)
      ...
      return 0
      ;;
    apps/taptrade-platform/revival/artifacts/*)
      printf 'low\tuntracked revival evidence artifact'
      return 0
      ;;
    apps/taptrade-platform/revival/signoffs/|\
apps/taptrade-platform/revival/signoffs/*)
...
auth_contract_count="$(count_status 'apps/taptrade-platform/go-platform/services/auth/')"
gateway_http_count="$(count_status 'apps/taptrade-platform/go-platform/services/gateway/internal/http/')"
gateway_alpha_cashier_count="$(count_status 'apps/taptrade-platform/go-platform/services/gateway/internal/alphacashier/')"
prediction_engine_count="$(count_status 'apps/taptrade-platform/go-platform/services/gateway/internal/prediction/')"
wallet_ledger_count="$(count_status 'apps/taptrade-platform/go-platform/services/gateway/internal/wallet/')"
economy_count="$(count_status 'apps/taptrade-platform/go-platform/services/gateway/internal/(bonus|leaderboards|loyalty|compliance)/')"
public_contract_count="$(count_status 'apps/taptrade-platform/(go-platform/services/gateway/api/openapi.yaml|frontend/packages/api-client/src/)')"
office_ops_count="$(count_status 'apps/taptrade-platform/frontend/packages/office/')"
player_surface_count="$(count_status 'apps/taptrade-platform/frontend/packages/app/')"
...
{
  awk '$1 ~ /M|D|A|R/ && $0 ~ /apps\/taptrade-platform\/go-platform\/services\/auth\// { print }' "$status_file"
  awk '$1 ~ /M|D|A|R/ && $0 ~ /apps\/taptrade-platform\/go-platform\/services\/gateway\/internal\/http\// { print }' "$status_file"
  awk '$1 ~ /M|D|A|R/ && $0 ~ /apps\/taptrade-platform\/go-platform\/services\/gateway\/internal\/alphacashier\// { print }' "$status_file"
  awk '$1 ~ /M|D|A|R/ && $0 ~ /apps\/taptrade-platform\/go-platform\/services\/gateway\/internal\/prediction\// { print }' "$status_file"
  awk '$1 ~ /M|D|A|R/ && $0 ~ /apps\/taptrade-platform\/go-platform\/services\/gateway\/internal\/wallet\// { print }' "$status_file"
  awk '$1 ~ /M|D|A|R/ && $0 ~ /apps\/taptrade-platform\/go-platform\/services\/gateway\/api\/openapi.yaml/ { print }' "$status_file"
  awk '$1 ~ /M|D|A|R/ && $0 ~ /apps\/taptrade-platform\/frontend\/packages\/api-client\/src\// { print }' "$status_file"
...
check_token() {
  ...
  local pattern="$3"
  local note="$4"
  local rel="apps/taptrade-platform/$path"
