...
func RunPhase6Backoffice(db *sql.DB) (*Phase6Stats, error) {
	...
	res, err := db.Exec(`
		...
		VALUES
		  -- 1: market halted (bot/admin halts BTC-100K market for news event)
		  (md5('audit-demo-1')::uuid,
		   'user-bot',
		   'market_halt',
		   'prediction_market',
		   md5('mkt-btc-100k-yes')::uuid::text,
		   'success',
		   '{"demo":true,"reason":"oracle_feed_outage","market_ticker":"BTC-100K-YES"}',
		   '10.0.0.1',
		   'Go-SeedAdmin/1.0',
		   NOW() - INTERVAL '6 days'),

		  -- 2: market resumed after feed restored
		  (md5('audit-demo-2')::uuid,
		   ...
		   md5('mkt-btc-100k-yes')::uuid::text,
		   'success',
		   '{"demo":true,"reason":"oracle_feed_restored","market_ticker":"BTC-100K-YES"}',
		   '10.0.0.1',
		   'Go-SeedAdmin/1.0',
		  ...
		  (md5('audit-demo-3')::uuid,
		   ...
		   'success',
		   '{"demo":true,"result":"yes","market_ticker":"SENATE-DEM-2026","payout_pool_cents":487200}',
		   '10.0.0.1',
		   'Go-SeedAdmin/1.0',
		   NOW() - INTERVAL '4 days'),
		  ...
		  (md5('audit-demo-4')::uuid,
		   ...
		   'success',
		   '{"demo":true,"result":"no","market_ticker":"GPT5-JUL26","payout_pool_cents":195000}',
		   '10.0.0.1',
		   'Go-SeedAdmin/1.0',
		  ...
		  (md5('audit-demo-7')::uuid,
		   ...
		   'success',
		   '{"demo":true,"market_ticker":"UCL-CITY-2526","yes_price_cents":38,"execution_mode":"order_book"}',
		   '172.16.0.5',
		   'BackofficeApp/3.1 (admin-panel)',
		   NOW() - INTERVAL '5 days'),
