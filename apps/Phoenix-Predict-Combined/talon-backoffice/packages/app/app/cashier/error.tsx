...
export default function CashierError({
  ...
  useEffect(() => {
    logger.error("CashierError", "Cashier page error", error);
  }, [error]);

  return (
    <div className={shellClass}>
      <div className={iconClass}>💳</div>
      <h2 className={titleClass}>Cashier Unavailable</h2>
      <p className={copyClass}>
        {error.message ||
          "We couldn't connect to the payment service. Your funds are safe — please try again in a moment."}
      </p>
