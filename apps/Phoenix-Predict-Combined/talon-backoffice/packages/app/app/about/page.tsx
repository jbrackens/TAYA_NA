...
<h2>Who We Are</h2>
<p>TAYA NA! is a prediction market platform where traders take positions on real-world outcomes — politics, crypto, sports, entertainment, tech, and economics. Markets price probability as cents (0–99) and pay out 100¢ per contract on the winning side.</p>
...
<p>TAYA NA! operates under applicable regulatory frameworks for event-contract trading. All trading activity is subject to the terms of service and applicable laws of the jurisdiction in which you are located.</p>

<h2>Contact</h2>
<p>For support inquiries, reach us at <a href="mailto:support@tayanapredict.com">support@tayanapredict.com</a>.</p>
`;
