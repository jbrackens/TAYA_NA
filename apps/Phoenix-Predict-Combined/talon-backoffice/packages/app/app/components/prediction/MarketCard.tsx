  ...
  return (
    ...
    >
      ...
      <div className="mkt-mid">
        <div className="mkt-side yes">
          ...
          <div className="mkt-side-price">
            ...
            <span className={`mkt-delta ${delta > 0 ? "up" : delta < 0 ? "dn" : "flat"}`}>
              {delta > 0 ? "+" : ""}
              {delta}¢
            </span>
          </div>
        ...
        <div className="mkt-side no">
          ...
          <div className="mkt-side-price">
            ...
            <span className={`mkt-delta ${delta > 0 ? "dn" : delta < 0 ? "up" : "flat"}`}>
              {delta > 0 ? "−" : delta < 0 ? "+" : ""}
              {Math.abs(delta)}¢
            </span>
          </div>
      ...
      <div className="mkt-foot">
        <span>{traders != null ? `${traders.toLocaleString()} traders` : "—"}</span>
