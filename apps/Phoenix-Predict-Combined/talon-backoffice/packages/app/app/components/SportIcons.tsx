...
> = {
  ...
  soccer: [
    ...
    {
      d: "M12 2l-1.5 5.5L7 5.5M12 2l1.5 5.5L17 5.5M7 5.5L3.5 10l3.5 2M17 5.5l3.5 4.5-3.5 2M7 12l-1 5.5L10.5 19M17 12l1 5.5-4.5 1.5M10.5 19h3M12 7.5L7 12l3.5 7h3L17 12Z",
      stroke: true,
    },
  ],
  futsal: [
  ...
  football: [
    {
      d: "M6.5 3.5C9 2 15 2 17.5 3.5 20 5 22 9 22 12s-2 7-4.5 8.5C15 22 9 22 6.5 20.5 4 19 2 15 2 12s2-7 4.5-8.5Z",
      stroke: true,
    },
  ...
  basketball: [
    ...
    {
      d: "M5.2 5.2c3.9 1.8 5.8 5.8 5.8 5.8M18.8 5.2c-3.9 1.8-5.8 5.8-5.8 5.8M5.2 18.8c3.9-1.8 5.8-5.8 5.8-5.8M18.8 18.8c-3.9-1.8-5.8-5.8-5.8-5.8",
      stroke: true,
    },
  ],
  ...
  tennis: [
    { d: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Z", stroke: true },
    {
      d: "M18.5 5.5C16 8 16 12 18.5 18.5M5.5 5.5C8 8 8 12 5.5 18.5",
      stroke: true,
    },
  ],
  ...
  baseball: [
    { d: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Z", stroke: true },
    {
      d: "M7 4c1 3 1 6 0 9M8 4.5l-.5 1M8 7l-.5 1M8 9.5l-.5 1M8 12l-.5 1M17 4c-1 3-1 6 0 9M16 4.5l.5 1M16 7l.5 1M16 9.5l.5 1M16 12l.5 1",
      stroke: true,
    },
  ],
  ...
  volleyball: [
    { d: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Z", stroke: true },
    {
      d: "M12 2C8 6 8 12 12 16s4 2 6 6M12 2c4 4 4 10 0 14s-4 2-6 6M2 12h20",
      stroke: true,
    },
  ],
  /* Handball */
  ...
  boxing: [
    {
      d: "M9 3c-2 0-4 2-4 4v4c0 3 2 6 5 7l2 1v2h6v-2l1-1c2-2 3-4 3-6V8c0-3-2-5-5-5H9Z",
      stroke: true,
    },
  ...
  cycling: [
    {
      d: "M5.5 17a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM18.5 17a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Z",
      stroke: true,
    },
  ...
  racing: [
    ...
    {
      d: "M4 3h4v5H4ZM12 3h4v5h-4ZM8 8h4v5H8ZM16 8h4v5h-4Z",
      fill: "currentColor",
    },
  ],
  "auto-racing": [
  ...
  bowling: [
    {
      d: "M12 2a3 3 0 0 0-3 3c0 1 .5 2 1 3l-1 12c0 1 1.5 2 3 2s3-1 3-2l-1-12c.5-1 1-2 1-3a3 3 0 0 0-3-3Z",
      stroke: true,
    },
...
// Each icon's `paths` entry. `stroke` defaults to true (use the parent
// SVG stroke); `fill` overrides to a solid color (rendered with stroke="none").
type SportPath = { d: string; stroke?: boolean; fill?: string };

const fallbackPaths: SportPath[] = [
  {
    d: "M6.5 6.5a3.5 3.5 0 1 0 0 7M17.5 6.5a3.5 3.5 0 1 1 0 7M6.5 10h11",
    stroke: true,
  },
];
