 ...
 *   Layer 2 (z -2): faint SVG "market chart" wavy lines in YES-blue,
 *     NO-peach, and mint-accent. A visual hint at market data without
  ...
  return (
    <div className="backdrop-scene" aria-hidden="true">
      ...
      >
        ...
        {/* YES (blue) — upper-middle, gentle drift upward */}
        <path
        ...
        {/* NO (peach) — lower half, crossing below YES */}
        <path
