...
import phoenix.wallets.WalletActorProtocol.events.FundsReservedForPrediction
...
import phoenix.wallets.WalletActorProtocol.events.PredictionCancelled
import phoenix.wallets.WalletActorProtocol.events.PredictionLost
import phoenix.wallets.WalletActorProtocol.events.PredictionPushed
import phoenix.wallets.WalletActorProtocol.events.PredictionResettled
import phoenix.wallets.WalletActorProtocol.events.PredictionVoided
import phoenix.wallets.WalletActorProtocol.events.PredictionWon
  ...
  def handle(repository: WalletTransactionRepository, event: WalletEvent): Future[Unit] =
    event match {
      ...
      case _: WalletCreated | _: BetCancelled | _: BetLost | _: BetVoided | _: BetPushed | _: BetWon |
          _: FundsReservedForBet | _: FundsReservedForPrediction | _: PredictionCancelled | _: PredictionLost |
          _: PredictionVoided | _: PredictionPushed | _: PredictionWon | _: PredictionResettled |
  ...
  private def pendingTransaction(event: TransactionEvent, transactionType: TransactionType): WalletTransaction = {
    val transactionDetails = event match {
      ...
      case _: FundsDeposited | _: FundsWithdrawn | _: FundsReservedForWithdrawal | _: WithdrawalConfirmed |
          _: WithdrawalCancelled | _: FundsReservedForBet | _: FundsReservedForPrediction | _: BetVoided |
          _: PredictionVoided | _: BetPushed | _: PredictionPushed | _: BetCancelled | _: PredictionCancelled |
          _: BetWon | _: PredictionWon | _: BetLost | _: PredictionLost | _: BetResettled |
          _: PredictionResettled =>
        None
    }
