  ...
  def handle(insertNotes: InsertNotes)(event: WalletEvent)(implicit ec: ExecutionContext): Future[Unit] =
    event match {
      ...
      case _: FundsDeposited | _: AdjustingFundsDeposited | _: AdjustingFundsWithdrawn | _: FundsWithdrawn |
          ...
          _: FundsReservedForPrediction | _: BetVoided | _: PredictionVoided | _: BetPushed | _: PredictionPushed |
          _: BetCancelled | _: PredictionCancelled | _: BetWon | _: PredictionWon | _: BetLost |
          _: PredictionLost | _: WalletCreated | _: ResponsibilityCheckAccepted |
          _: ResponsibilityCheckAcceptanceRequested | _: BetResettled | _: PredictionResettled |
