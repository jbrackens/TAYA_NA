...
object PunterTapirEndpoints extends TapirCodecEnumeratum {
  ...
  final case class ProductExposureSummary(openExposure: RealMoney)
  final case class PredictionProductSummary(
      openExposure: RealMoney,
      openOrders: Int,
      settledOrders: Int,
      cancelledOrders: Int)
  final case class FinancialSummaryProductBreakdown(
