...
classify_deleted_path() {
  ...
  case "$path" in
    apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/cashier/*)
      ...
      return 0
      ;;
    apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/components/CashierCanaryPanel.tsx|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/components/CryptoDepositCard.tsx|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/components/DepositThresholdModal.tsx|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/components/NonCustodialCashierStatus.tsx)
      echo "player launch-prohibited cashier/payment component"
      return 0
      ;;
    apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/lib/api/alpha-cashier-client.ts|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/lib/api/crypto-client.ts|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/lib/api/noncustodial-cashier-client.ts)
      echo "player launch-prohibited cashier/crypto API client"
      return 0
      ;;
    apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/lib/store/cashierSlice.ts|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/lib/store/predictionSlice.ts|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/lib/services/currency.ts|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/lib/utils/odds.ts|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/lib/format.ts)
      echo "player retired money/sportsbook helper replaced by point-native surfaces"
      return 0
      ;;
    apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/__tests__/alpha-cashier.test.ts|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/__tests__/bet-placement.test.ts|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/__tests__/odds.test.ts)
      echo "player retired launch-incompatible test replaced by point-native regressions"
      return 0
      ;;
    apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/public/static/locales/*/cashier.json|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/public/static/locales/*/deposit-limits.json|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/public/static/locales/*/deposit-threshold.json)
      echo "player launch-prohibited cashier/deposit locale bundle"
      return 0
      ;;
    apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/app/\(dashboard\)/cashier/page.tsx|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/containers/provider-ops/cashier-review.tsx|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/components/users/transaction-modal/index.tsx|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/components/users/wallet/table-actions/index.tsx|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/components/users/wallet/table-actions/index.styled.ts)
      echo "office launch-prohibited or launch-adjacent money admin surface"
      return 0
      ;;
    apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/tests/alpha-cashier-review.test.ts)
      echo "office retired launch-incompatible cashier test replaced by route/account-review regressions"
      return 0
      ;;
    apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/components/audit-logs/utils/__tests__/resolvers.test.ts|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/lib/slices/__tests__/logsSlice.test.ts|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/lib/slices/__tests__/usersDetailsAuditSlice.test.ts|\
apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/lib/slices/__tests__/usersRecentActivitySlices.test.ts)
      echo "office test relocated to package-level regression suite"
      return 0
      ;;
    apps/Phoenix-Predict-Combined/go-platform/services/gateway/cmd/reconciliation-report/*|\
...
"office launch-prohibited or launch-adjacent money admin surface")
      ...
      [[ -f "$ROOT/talon-backoffice/scripts/qa/live-no-money-boundary.mjs" ]] || return 1
      rg -q '"/cashier"|"/cashout"|"/crypto"|"/deposit"|"/withdraw' "$ROOT/talon-backoffice/scripts/qa/live-no-money-boundary.mjs" || return 1
      echo "\`scripts/qa/live-no-money-boundary.sh\` + \`talon-backoffice/scripts/qa/live-no-money-boundary.mjs\` prove retired money routes/API paths remain absent at runtime."
      return 0
      ;;
    "player retired money/sportsbook helper replaced by point-native surfaces")
      [[ -f "$ROOT/talon-backoffice/packages/app/app/lib/point-ledger.ts" ]] || return 1
      [[ -f "$ROOT/talon-backoffice/packages/app/app/lib/api/wallet-client.ts" ]] || return 1
      [[ -f "$ROOT/talon-backoffice/packages/app/app/__tests__/point-ledger.test.ts" ]] || return 1
      rg -q 'Order points locked|Settlement points|Starter points' "$ROOT/talon-backoffice/packages/app/app/lib/point-ledger.ts" || return 1
      rg -q 'does not preserve retired deposit or withdrawal type branches' "$ROOT/talon-backoffice/packages/app/app/__tests__/point-ledger.test.ts" || return 1
    ...
    "player retired launch-incompatible test replaced by point-native regressions")
      [[ -f "$ROOT/talon-backoffice/packages/app/app/__tests__/point-ledger.test.ts" ]] || return 1
      rg -q 'forbiddenValueTerms|does not preserve retired deposit or withdrawal type branches' "$ROOT/talon-backoffice/packages/app/app/__tests__/point-ledger.test.ts" || return 1
    ...
    "office retired launch-incompatible cashier test replaced by route/account-review regressions")
      [[ -f "$ROOT/talon-backoffice/packages/office/tests/recent-activities.test.ts" ]] || return 1
      [[ -f "$ROOT/talon-backoffice/packages/office/tests/users-recent-activity-slices.test.ts" ]] || return 1
      rg -q 'PTS|wallet_transaction' "$ROOT/talon-backoffice/packages/office/tests/recent-activities.test.ts" || return 1
      rg -q 'PTS|wallet_transaction' "$ROOT/talon-backoffice/packages/office/tests/users-recent-activity-slices.test.ts" || return 1
    ...
    "office test relocated to package-level regression suite")
      [[ -f "$ROOT/talon-backoffice/packages/office/tests/audit-log-resolvers.test.ts" ]] || return 1
      [[ -f "$ROOT/talon-backoffice/packages/office/tests/audit-log-slices.test.ts" ]] || return 1
      [[ -f "$ROOT/talon-backoffice/packages/office/tests/users-recent-activity-slices.test.ts" ]] || return 1
      rg -q 'legacy audit|legacy actions|audit log' "$ROOT/talon-backoffice/packages/office/tests/audit-log-resolvers.test.ts" || return 1
      rg -q 'legacy audit|auditLogs|legacy actions' "$ROOT/talon-backoffice/packages/office/tests/audit-log-slices.test.ts" || return 1
