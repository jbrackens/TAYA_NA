...
OPENAPI_PATH="apps/Phoenix-Predict-Combined/go-platform/services/gateway/api/openapi.yaml"
HANDLERS_PATH="apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/handlers.go"
WALLET_HANDLERS_PATH="apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/wallet_handlers.go"
PREDICTION_HANDLERS_PATH="apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_handlers.go"
API_CLIENT_PATH="apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/client.ts"
PREDICTION_CLIENT_PATH="apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/prediction-client.ts"
APP_WALLET_CLIENT_PATH="apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/lib/api/wallet-client.ts"
