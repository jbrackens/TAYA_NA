...
- Generated: `2026-06-30T12:59:48Z`
...
- Modified tracked artifacts classified: `422`
- High-risk contract files: `102`
- Large-change threshold: `250` changed lines
- Large-change files: `37`
- Tracked line churn: `+33719 / -6725`
...
| high | backend JVM dependency and classpath contract | 46 | 7 | 53 | `apps/Phoenix-Predict-Combined/phoenix-backend/project/Dependencies.scala` |
...
| high | backend JVM build and dependency override contract | 5 | 3 | 8 | `apps/Phoenix-Predict-Combined/phoenix-backend/build.sbt` |
