...
- Generated: `2026-06-29T08:37:26.285Z`
- Result: **pass**
...
|---|---:|---:|---|---|
| Talon workspace | 0 | 5 | `ip|GHSA-2p57-rm9w-gvfp` (3), `lodash.set|GHSA-p6mc-m468-83gw` (2) | `/Users/john/Sandbox/Taya_NA_Predict/Taya_Na_Predict/apps/Phoenix-Predict-Combined/revival/artifacts/talon_yarn_audit_2026-03-02.log` |
| Tiangge player app | 0 | 5 | `ip|GHSA-2p57-rm9w-gvfp` (3), `lodash.set|GHSA-p6mc-m468-83gw` (2) | `/Users/john/Sandbox/Taya_NA_Predict/Taya_Na_Predict/apps/Phoenix-Predict-Combined/revival/artifacts/tiangge_player_yarn_audit_2026-03-02.log` |
