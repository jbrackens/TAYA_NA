...
- Generated: `2026-06-30T07:42:33Z`
...
- Modified tracked artifacts classified: `412`
- High-risk contract files: `92`
- Large-change threshold: `250` changed lines
- Large-change files: `37`
- Tracked line churn: `+32829 / -6679`
...
| high | gateway HTTP and admin handlers | 336 | 37 | 373 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/loyalty_handlers.go` |
...
| high | gateway HTTP and admin handlers | 277 | 4 | 281 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/loyalty_handlers_test.go` |
