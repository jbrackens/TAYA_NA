...
- Generated: `2026-06-30T17:16:08Z`
...
- Shortstat: ` 539 files changed, 33863 insertions(+), 14001 deletions(-)`
...
| Untracked artifacts in scope | 871 |
...
|---|---|---:|
| high | untracked gateway HTTP/admin behavior or tests | 19 |
...
| low | untracked revival evidence report | 608 |
