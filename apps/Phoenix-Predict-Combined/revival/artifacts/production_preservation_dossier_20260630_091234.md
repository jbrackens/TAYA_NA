...
- Generated: `2026-06-30T09:12:38Z`
...
- Shortstat: ` 469 files changed, 33412 insertions(+), 13861 deletions(-)`
...
| Status | Count |
|---|---:|
| Modified tracked files | 415 |
| Deleted tracked files | 54 |
| Added tracked files | 0 |
| Renamed tracked files | 0 |
| Untracked artifacts in scope | 644 |
| Unclassified untracked artifacts | 1 |
...
| Prediction engine and persistence | 20 |
...
| low | untracked revival evidence report | 387 |
