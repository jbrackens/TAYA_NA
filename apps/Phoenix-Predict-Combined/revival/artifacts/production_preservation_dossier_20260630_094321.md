...
- Generated: `2026-06-30T09:43:23Z`
...
- Shortstat: ` 474 files changed, 33619 insertions(+), 13890 deletions(-)`
...
| Gateway HTTP/admin handlers | 47 |
...
| Status | Path |
|---|---|
| D | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/testdata/reconciliation/lifecycle_cases.json` |
| D | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/testdata/seeds/read-model.seed 2.json` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/auth/internal/http/handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/auth/internal/http/handlers_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/api/openapi.yaml` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/admin_dispute_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/admin_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/admin_risk_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/authz_hardening_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/bonus_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/bot_compliance_gate_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/bot_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/content_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/dispute_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/edge_auth_gate_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/kyc_admin_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/leaderboard_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/leaderboard_handlers_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/loyalty_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/loyalty_handlers_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/metrics_infra.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/metrics_infra_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/order_validation_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/partner_admin_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/partner_admin_handlers_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_leaderboard_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_leaderboard_handlers_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_leaderboards_admin_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_loyalty_admin_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_loyalty_admin_handlers_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_loyalty_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_loyalty_handlers_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_admin_audit_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_admin_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_admin_handlers_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_admin_routes_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/pretrade_gate.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/pretrade_gate_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/ratelimit.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/ratelimit_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/rbac_admin_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/rbac_admin_handlers_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/reports_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/wallet_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/wallet_handlers_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/webhook_admin_handlers.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/webhook_admin_handlers_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/webhook_wiring.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/accounting.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/amm.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/compliance_gate_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/exchange.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/feed/crypto.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/feed/resolution_source.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/json_defaults_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/lifecycle.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/lifecycle_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/market_filter_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/orderbook_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/preview_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/repository.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/risk.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/service.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/settlement.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/settlement_audit_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/sql_admin_repository.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/sql_exchange_repository.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/sql_repository.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/sql_resolution_store.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/types.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/wallet_wiring_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/workers/expirer.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/wallet/bonus_ops.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/wallet/service.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/wallet/service_test.go` |
| M | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/wallet/wagering.go` |
| M | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/client.ts` |
| M | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/index.ts` |
| M | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/prediction-client.ts` |
| M | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/prediction-types.ts` |
| M | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/types.ts` |
...
|---|---|---:|
| high | untracked gateway HTTP/admin behavior or tests | 18 |
...
| low | untracked revival evidence report | 405 |
...
| medium | untracked verification or security governance | 12 |
