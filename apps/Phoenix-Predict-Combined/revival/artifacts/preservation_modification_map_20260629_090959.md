...
- Generated: `2026-06-29T09:10:12Z`
...
| low | revival evidence report | 22 | 19 | 41 | `apps/Phoenix-Predict-Combined/revival/06_DEPENDENCY_VULNERABILITY_BASELINE.md` |
...
| medium | verification and release governance | 60 | 30 | 90 | `apps/Phoenix-Predict-Combined/Makefile` |
...
| medium | verification and release governance | 43 | 33 | 76 | `apps/Phoenix-Predict-Combined/scripts/pre-commit-hook.sh` |
| medium | verification and release governance | 38 | 280 | 318 | `apps/Phoenix-Predict-Combined/scripts/qa/go-capability-slo-gate.sh` |
...
| medium | verification and release governance | 11 | 18 | 29 | `apps/Phoenix-Predict-Combined/scripts/release/launch-readiness-gate.sh` |
...
| medium | verification and release governance | 10 | 0 | 10 | `apps/Phoenix-Predict-Combined/scripts/security/jvm-dependency-baseline.sh` |
