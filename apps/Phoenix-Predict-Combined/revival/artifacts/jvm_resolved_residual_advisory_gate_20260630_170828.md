...
- Generated: `2026-06-30T17:08:28.292Z`
- Result: **pass**
- Source JSON: `/Users/john/Sandbox/Taya_NA_Predict/Taya_Na_Predict/apps/Phoenix-Predict-Combined/revival/artifacts/jvm_osv_resolved_classpath_baseline_20260630_170146.json`
...
- Coordinates with resolved classpath OSV findings: `8`
- Unique OSV vulnerability ids: `28`
- Reviewed residual policy entries: `8`

## Verification

- Every resolved classpath JVM OSV finding matched the reviewed residual package, version, advisory id set, and rationale.
- No unreviewed resolved classpath JVM OSV finding was observed.
- Stale reviewed residual entries fail so remediated findings can be removed from the policy.
