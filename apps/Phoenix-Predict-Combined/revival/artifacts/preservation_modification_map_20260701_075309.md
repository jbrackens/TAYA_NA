...
- Generated: `2026-07-01T07:53:24Z`
...
- Modified tracked artifacts classified: `490`
- High-risk contract files: `130`
- Large-change threshold: `250` changed lines
- Large-change files: `40`
- Tracked line churn: `+36178 / -6951`
...
| high | backend JVM build and dependency override contract | 1 |
| high | backend JVM build and scalafix toolchain contract | 2 |
| high | backend JVM dependency and classpath contract | 1 |
| high | backend auth/session compatibility contract | 1 |
| high | backend core compiler compatibility contract | 1 |
| high | backend inherited feed compiler compatibility contract | 2 |
| high | backend inherited runtime compiler compatibility contract | 18 |
| high | gateway HTTP and admin handlers | 48 |
| high | gateway economy, rank, or compliance logic | 16 |
| high | gateway guarded legacy transfer compatibility | 2 |
| high | gateway point-wallet ledger contract | 4 |
| high | gateway prediction engine and persistence | 24 |
| high | gateway runtime wiring | 2 |
| high | public API/client contract | 6 |
| low | backend inherited feed regression test compatibility | 7 |
| low | backend service regression test compatibility | 31 |
| low | frontend package metadata | 2 |
| low | go platform documentation or dependency metadata | 3 |
| low | office regression tests | 4 |
| low | player launch copy and locale bundle | 137 |
| low | player regression tests | 11 |
| low | revival evidence report | 9 |
| medium | backend integration test harness compatibility | 2 |
| medium | gateway discovery or guarded legacy compatibility | 5 |
| medium | gateway schema and seed data | 12 |
| medium | office admin and operations surface | 48 |
...
| medium | verification and release governance | 21 |

## High-Risk Or Large-Change Files

| Risk | Classification | + | - | Churn | Path |
|---|---|---:|---:|---:|---|
| high | public API/client contract | 3587 | 106 | 3693 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/api/openapi.yaml` |
| high | gateway HTTP and admin handlers | 2986 | 25 | 3011 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/wallet_handlers_test.go` |
| high | gateway HTTP and admin handlers | 1981 | 43 | 2024 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_admin_handlers_test.go` |
| low | player regression tests | 1892 | 34 | 1926 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/__tests__/qa-regressions-2026-04-18.test.ts` |
| high | gateway HTTP and admin handlers | 1373 | 37 | 1410 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/wallet_handlers.go` |
| high | gateway HTTP and admin handlers | 1073 | 181 | 1254 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_handlers.go` |
| high | public API/client contract | 1065 | 28 | 1093 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/prediction-client.ts` |
...
| low | player regression tests | 758 | 26 | 784 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/__tests__/wallet-paths.test.ts` |
| low | office regression tests | 709 | 8 | 717 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/tests/app-router-legacy-routes.test.ts` |
...
| high | gateway HTTP and admin handlers | 577 | 3 | 580 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/leaderboard_handlers_test.go` |
| high | gateway point-wallet ledger contract | 531 | 32 | 563 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/wallet/service.go` |
...
| high | gateway HTTP and admin handlers | 387 | 61 | 448 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/bonus_handlers.go` |
| high | gateway HTTP and admin handlers | 430 | 4 | 434 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/loyalty_handlers_test.go` |
| high | gateway prediction engine and persistence | 426 | 0 | 426 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/json_defaults_test.go` |
| high | gateway economy, rank, or compliance logic | 404 | 0 | 404 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/compliance/handlers_d6_test.go` |
| high | gateway HTTP and admin handlers | 361 | 37 | 398 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/loyalty_handlers.go` |
| high | gateway prediction engine and persistence | 314 | 80 | 394 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/service.go` |
| high | public API/client contract | 324 | 69 | 393 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/prediction-types.ts` |
| high | gateway HTTP and admin handlers | 335 | 35 | 370 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/leaderboard_handlers.go` |
...
| high | gateway HTTP and admin handlers | 345 | 1 | 346 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/alpha_cashier_admin_handlers_test.go` |
| low | frontend package metadata | 108 | 235 | 343 | `apps/Phoenix-Predict-Combined/talon-backoffice/yarn.lock` |
| high | gateway economy, rank, or compliance logic | 274 | 63 | 337 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/compliance/handlers.go` |
| high | gateway HTTP and admin handlers | 333 | 0 | 333 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/bot_compliance_gate_test.go` |
...
| high | gateway HTTP and admin handlers | 280 | 8 | 288 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_leaderboard_handlers_test.go` |
...
| high | gateway HTTP and admin handlers | 240 | 12 | 252 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/order_validation_test.go` |
...
| high | gateway HTTP and admin handlers | 209 | 3 | 212 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/admin_risk_handlers.go` |
| high | gateway HTTP and admin handlers | 188 | 14 | 202 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/content_handlers.go` |
| high | gateway HTTP and admin handlers | 191 | 10 | 201 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_admin_routes_test.go` |
| high | gateway HTTP and admin handlers | 156 | 29 | 185 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_admin_handlers.go` |
| high | gateway HTTP and admin handlers | 173 | 0 | 173 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/ratelimit.go` |
| high | gateway guarded legacy transfer compatibility | 109 | 32 | 141 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/alphacashier/handlers.go` |
...
| high | gateway HTTP and admin handlers | 116 | 18 | 134 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/alpha_cashier_admin_handlers.go` |
...
| high | gateway HTTP and admin handlers | 115 | 9 | 124 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_loyalty_admin_handlers_test.go` |
| high | gateway HTTP and admin handlers | 119 | 5 | 124 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_loyalty_handlers_test.go` |
| high | gateway HTTP and admin handlers | 116 | 1 | 117 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/rbac_admin_handlers_test.go` |
| high | public API/client contract | 109 | 6 | 115 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/client.ts` |
| high | gateway HTTP and admin handlers | 108 | 0 | 108 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/webhook_admin_handlers_test.go` |
...
| high | gateway HTTP and admin handlers | 73 | 18 | 91 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/rbac_admin_handlers.go` |
...
| high | gateway HTTP and admin handlers | 83 | 0 | 83 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/partner_admin_handlers_test.go` |
| high | gateway HTTP and admin handlers | 75 | 8 | 83 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/prediction_admin_audit_test.go` |
| high | gateway prediction engine and persistence | 76 | 1 | 77 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/lifecycle_test.go` |
| high | gateway runtime wiring | 52 | 19 | 71 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/cmd/gateway/main.go` |
| high | backend JVM dependency and classpath contract | 57 | 11 | 68 | `apps/Phoenix-Predict-Combined/phoenix-backend/project/Dependencies.scala` |
...
| high | gateway HTTP and admin handlers | 54 | 8 | 62 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/bot_handlers.go` |
| high | gateway prediction engine and persistence | 60 | 1 | 61 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/sql_exchange_repository.go` |
| high | gateway HTTP and admin handlers | 51 | 6 | 57 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_leaderboard_handlers.go` |
...
| high | gateway HTTP and admin handlers | 45 | 10 | 55 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/webhook_admin_handlers.go` |
| high | gateway HTTP and admin handlers | 49 | 2 | 51 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/dispute_handlers.go` |
| high | gateway HTTP and admin handlers | 33 | 14 | 47 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_loyalty_handlers.go` |
...
| high | gateway HTTP and admin handlers | 29 | 15 | 44 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/kyc_admin_handlers.go` |
| high | gateway HTTP and admin handlers | 25 | 19 | 44 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_leaderboards_admin_handlers.go` |
| high | gateway guarded legacy transfer compatibility | 43 | 0 | 43 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/alphacashier/preflight.go` |
...
| high | gateway HTTP and admin handlers | 36 | 2 | 38 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/user_handlers.go` |
| high | gateway HTTP and admin handlers | 29 | 6 | 35 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/predict_loyalty_admin_handlers.go` |
...
| high | gateway HTTP and admin handlers | 22 | 6 | 28 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/admin_dispute_handlers.go` |
| high | public API/client contract | 17 | 11 | 28 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/types.ts` |
...
| high | gateway prediction engine and persistence | 17 | 10 | 27 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/compliance_gate_test.go` |
| high | gateway prediction engine and persistence | 14 | 12 | 26 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/settlement.go` |
...
| high | gateway HTTP and admin handlers | 23 | 0 | 23 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/ratelimit_test.go` |
...
| high | gateway HTTP and admin handlers | 11 | 6 | 17 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/http/partner_admin_handlers.go` |
...
| high | public API/client contract | 9 | 7 | 16 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/index.ts` |
| high | backend inherited runtime compiler compatibility contract | 10 | 5 | 15 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/dbviews/infrastructure/SlickView06SportsWagersRepository.scala` |
| high | gateway prediction engine and persistence | 7 | 7 | 14 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/exchange.go` |
...
| high | backend inherited runtime compiler compatibility contract | 6 | 4 | 10 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/migrations/MarketsMigrator.scala` |
| high | backend JVM build and dependency override contract | 5 | 4 | 9 | `apps/Phoenix-Predict-Combined/phoenix-backend/build.sbt` |
| high | backend inherited runtime compiler compatibility contract | 5 | 4 | 9 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/softplay/infrastructure/SoftPlaySetParameters.scala` |
...
| high | backend inherited runtime compiler compatibility contract | 4 | 3 | 7 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/punters/infrastructure/http/PunterBackofficeRoutes.scala` |
| high | gateway prediction engine and persistence | 2 | 2 | 4 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/workers/expirer.go` |
| high | backend inherited runtime compiler compatibility contract | 3 | 1 | 4 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/http/routes/backoffice/BackofficeRoutes.scala` |
| high | backend inherited runtime compiler compatibility contract | 2 | 2 | 4 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/punters/domain/PunterSessionsLog.scala` |
| high | backend inherited runtime compiler compatibility contract | 3 | 1 | 4 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/suppliers/betgenius/BetgeniusStreamConsumer.scala` |
| high | backend inherited runtime compiler compatibility contract | 2 | 2 | 4 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/wallets/WalletsBoundedContext.scala` |
| high | gateway prediction engine and persistence | 2 | 1 | 3 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/sql_resolution_store.go` |
| high | backend inherited feed compiler compatibility contract | 2 | 1 | 3 | `apps/Phoenix-Predict-Combined/phoenix-backend/data-pipeline/oddin/lib/src/main/scala/phoenix/oddin/infrastructure/OddinMessageAdapter.scala` |
| high | backend inherited feed compiler compatibility contract | 2 | 1 | 3 | `apps/Phoenix-Predict-Combined/phoenix-backend/data-pipeline/oddin/lib/src/main/scala/phoenix/oddin/infrastructure/http/AkkaHttpOddinRestApi.scala` |
| high | backend inherited runtime compiler compatibility contract | 2 | 1 | 3 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/bets/ActorBetsBoundedContext.scala` |
| high | backend inherited runtime compiler compatibility contract | 2 | 1 | 3 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/markets/fixtures/FixturesProjectionHandler.scala` |
| high | backend inherited runtime compiler compatibility contract | 2 | 1 | 3 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/markets/sports/SportsProjectionHandler.scala` |
...
| high | gateway prediction engine and persistence | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/internal/prediction/accounting.go` |
| high | backend core compiler compatibility contract | 0 | 2 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/core/src/main/scala/phoenix/core/EitherTUtils.scala` |
| high | backend auth/session compatibility contract | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/core/src/main/scala/phoenix/jwt/CustomKeycloakDeploymentBuilder.scala` |
| high | backend JVM build and scalafix toolchain contract | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/project/Build.scala` |
| high | backend JVM build and scalafix toolchain contract | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/project/plugins.sbt` |
| high | backend inherited runtime compiler compatibility contract | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/dbviews/infrastructure/View08PatronGameLimsProjectionHandler.scala` |
| high | backend inherited runtime compiler compatibility contract | 0 | 2 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/prediction/botauth/infrastructure/http/PredictionBotRoutes.scala` |
| high | backend inherited runtime compiler compatibility contract | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/projections/DomainMappers.scala` |
| high | backend inherited runtime compiler compatibility contract | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/punters/ActorPuntersBoundedContext.scala` |
| high | backend inherited runtime compiler compatibility contract | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/punters/idcomply/infrastructure/AkkaHttpIdComplyService.scala` |
| high | backend inherited runtime compiler compatibility contract | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/punters/infrastructure/http/PunterRoutes.scala` |
| high | backend inherited runtime compiler compatibility contract | 0 | 1 | 1 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/main/scala/phoenix/markets/tournaments/DisplayableTournamentsTable.scala` |
...
| high | public API/client contract | 324 | 69 | 393 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/prediction-types.ts` |
| high | public API/client contract | 17 | 11 | 28 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/api-client/src/types.ts` |
| low | backend inherited feed regression test compatibility | 3 | 2 | 5 | `apps/Phoenix-Predict-Combined/phoenix-backend/data-pipeline/oddin/lib/src/test/scala/phoenix/oddin/integration/OddinRestApiCachedMarketDescriptionsRepositorySpec.scala` |
| low | backend inherited feed regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/data-pipeline/oddin/lib/src/test/scala/phoenix/oddin/integration/akkastreams/MarketCancelFlowSpec.scala` |
| low | backend inherited feed regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/data-pipeline/oddin/lib/src/test/scala/phoenix/oddin/integration/akkastreams/MarketSettlementFlowSpec.scala` |
| low | backend inherited feed regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/data-pipeline/oddin/lib/src/test/scala/phoenix/oddin/integration/akkastreams/OddinMessageAdapterSpec.scala` |
| low | backend inherited feed regression test compatibility | 3 | 2 | 5 | `apps/Phoenix-Predict-Combined/phoenix-backend/data-pipeline/oddin/lib/src/test/scala/phoenix/oddin/integration/akkastreams/OddinStreamsSpec.scala` |
| low | backend inherited feed regression test compatibility | 3 | 2 | 5 | `apps/Phoenix-Predict-Combined/phoenix-backend/data-pipeline/oddin/lib/src/test/scala/phoenix/oddin/integration/akkastreams/OddsChangeFlowSpec.scala` |
| low | backend inherited feed regression test compatibility | 2 | 1 | 3 | `apps/Phoenix-Predict-Combined/phoenix-backend/data-pipeline/oddin/lib/src/test/scala/phoenix/oddin/integration/http/AkkaHttpOddinRestApiSpec.scala` |
| low | backend service regression test compatibility | 2 | 2 | 4 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/auditlog/unit/AuditLogBackofficeRoutesSpec.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/bets/infrastructure/akka/BetEventsWebSocketSingleton.scala` |
| low | backend service regression test compatibility | 0 | 1 | 1 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/boundedcontexts/market/InMemoryMarkets.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/http/routes/BackofficeFixtureRoutesSpec.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/http/routes/BackofficeMarketRoutesSpec.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/http/routes/BackofficeTournamentRoutesSpec.scala` |
| low | backend service regression test compatibility | 11 | 0 | 11 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/http/routes/DevRoutesSpec.scala` |
| low | backend service regression test compatibility | 3 | 2 | 5 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/http/routes/PhoenixRestRoutesSpec.scala` |
| low | backend service regression test compatibility | 2 | 2 | 4 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/http/support/PhoenixRestRoutesBuilder.scala` |
| low | backend service regression test compatibility | 4 | 3 | 7 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/payments/unit/PaymentsRoutesSpec.scala` |
| low | backend service regression test compatibility | 3 | 2 | 5 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/application/CreateUserUseCaseSpec.scala` |
| low | backend service regression test compatibility | 3 | 2 | 5 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/application/LoginProcessSpec.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/application/RefreshTokenUseCaseSpec.scala` |
| low | backend service regression test compatibility | 2 | 1 | 3 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/application/SelfExcludeSpec.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/exclusion/unit/SelfExcludedPuntersProjectionHandlerSpecWithVerification.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/idcomply/application/CheckIDPVStatusSpec.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/idcomply/integration/AkkaHttpIdComplyServiceIntegrationSpec.scala` |
| low | backend service regression test compatibility | 2 | 3 | 5 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/idcomply/support/RegistrationDataGenerator.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/infrastructure/ExceededSessionJobSpec.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/integration/PuntersRepositorySpec.scala` |
| low | backend service regression test compatibility | 0 | 1 | 1 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/unit/KeycloakConversionsSpec.scala` |
| low | backend service regression test compatibility | 3 | 3 | 6 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/unit/PunterEventNotificationHandlerSpec.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/punters/unit/WalletPunterStatusEventHandlerSpec.scala` |
| low | backend service regression test compatibility | 3 | 2 | 5 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/reports/acceptance/AMLReportsGenerationAcceptanceSpec.scala` |
| low | backend service regression test compatibility | 3 | 2 | 5 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/reports/acceptance/ReportsModuleAcceptanceSpec.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/softplay/application/CreateSoftPlayReportSpec.scala` |
| low | backend service regression test compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/suppliers/betgenius/PhoenixBetgeniusFlowsSpec.scala` |
| low | backend service regression test compatibility | 2 | 2 | 4 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/suppliers/oddin/FixturesCollectorSpec.scala` |
| low | backend service regression test compatibility | 2 | 2 | 4 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/suppliers/oddin/SportsCollectorSpec.scala` |
| low | backend service regression test compatibility | 2 | 2 | 4 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/suppliers/oddin/StronglyTypedOddinFlowsCommonSpec.scala` |
| low | backend service regression test compatibility | 2 | 2 | 4 | `apps/Phoenix-Predict-Combined/phoenix-backend/services/src/test/scala/phoenix/suppliers/oddin/StronglyTypedOddinFlowsSpec.scala` |
| low | frontend package metadata | 20 | 1 | 21 | `apps/Phoenix-Predict-Combined/talon-backoffice/package.json` |
| low | frontend package metadata | 108 | 235 | 343 | `apps/Phoenix-Predict-Combined/talon-backoffice/yarn.lock` |
...
| low | go platform documentation or dependency metadata | 13 | 13 | 26 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/Makefile` |
...
| low | office regression tests | 16 | 6 | 22 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/containers/audit-logs/__tests__/audit-logs.test.tsx` |
| low | office regression tests | 5 | 5 | 10 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/containers/audit-logs/utils/__tests__/scoped-copy-telemetry.test.ts` |
| low | office regression tests | 709 | 8 | 717 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/tests/app-router-legacy-routes.test.ts` |
...
| low | revival evidence report | 25 | 22 | 47 | `apps/Phoenix-Predict-Combined/revival/06_DEPENDENCY_VULNERABILITY_BASELINE.md` |
| low | revival evidence report | 7 | 8 | 15 | `apps/Phoenix-Predict-Combined/revival/12_JVM_DEPENDENCY_BASELINE.md` |
...
| medium | backend integration test harness compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/core/src/test/scala/phoenix/support/ActorSystemIntegrationSpec.scala` |
| medium | backend integration test harness compatibility | 1 | 1 | 2 | `apps/Phoenix-Predict-Combined/phoenix-backend/core/src/test/scala/phoenix/testcontainers/Postgres.scala` |
...
| medium | gateway schema and seed data | 72 | 39 | 111 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/cmd/seed/cleanup.go` |
| medium | gateway schema and seed data | 216 | 3 | 219 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/cmd/seed/cleanup_test.go` |
| medium | gateway schema and seed data | 26 | 3 | 29 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/cmd/seed/demo.go` |
| medium | gateway schema and seed data | 17 | 16 | 33 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/cmd/seed/demo_phase1_book.go` |
| medium | gateway schema and seed data | 13 | 9 | 22 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/cmd/seed/demo_phase4_user.go` |
| medium | gateway schema and seed data | 6 | 6 | 12 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/cmd/seed/demo_phase5_settle.go` |
| medium | gateway schema and seed data | 9 | 9 | 18 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/cmd/seed/demo_phase6_backoffice.go` |
| medium | gateway schema and seed data | 3 | 3 | 6 | `apps/Phoenix-Predict-Combined/go-platform/services/gateway/cmd/seed/main.go` |
...
| medium | office admin and operations surface | 4 | 4 | 8 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/README.md` |
...
| medium | office admin and operations surface | 87 | 36 | 123 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/app/(dashboard)/prediction-admin/risk/page.tsx` |
...
| medium | office admin and operations surface | 2 | 1 | 3 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/components/audit-logs/index.tsx` |
...
| medium | office admin and operations surface | 3 | 114 | 117 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/components/users/bets/cancel/index.tsx` |
...
| medium | office admin and operations surface | 14 | 1 | 15 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/components/users/limits-history/index.tsx` |
| medium | office admin and operations surface | 43 | 35 | 78 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/components/users/limits/update.tsx` |
...
| medium | office admin and operations surface | 14 | 0 | 14 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/containers/audit-logs/index.tsx` |
| medium | office admin and operations surface | 15 | 4 | 19 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/containers/audit-logs/utils/scoped-copy-telemetry.ts` |
| medium | office admin and operations surface | 450 | 64 | 514 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/containers/prediction-markets/index.tsx` |
...
| medium | office admin and operations surface | 3 | 5 | 8 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/next.config.js` |
| medium | office admin and operations surface | 1 | 2 | 3 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/providers/menu/defaults.ts` |
| medium | office admin and operations surface | 7 | 10 | 17 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/providers/menu/structure.ts` |
...
| medium | office admin and operations surface | 15 | 22 | 37 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/translations/en/page-transactions.js` |
| medium | office admin and operations surface | 26 | 25 | 51 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/translations/en/page-users-details.js` |
| medium | office admin and operations surface | 10 | 10 | 20 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/office/types/punters.ts` |
...
| medium | player launch user surface | 41 | 62 | 103 | `apps/Phoenix-Predict-Combined/talon-backoffice/packages/app/app/portfolio/page.tsx` |
...
| medium | verification and release governance | 104 | 30 | 134 | `apps/Phoenix-Predict-Combined/Makefile` |
...
| medium | verification and release governance | 45 | 33 | 78 | `apps/Phoenix-Predict-Combined/scripts/pre-commit-hook.sh` |
| medium | verification and release governance | 38 | 280 | 318 | `apps/Phoenix-Predict-Combined/scripts/qa/go-capability-slo-gate.sh` |
...
| medium | verification and release governance | 26 | 18 | 44 | `apps/Phoenix-Predict-Combined/scripts/release/launch-readiness-gate.sh` |
...
| medium | verification and release governance | 82 | 26 | 108 | `apps/Phoenix-Predict-Combined/scripts/security/dependency-baseline.sh` |
| medium | verification and release governance | 7 | 4 | 11 | `apps/Phoenix-Predict-Combined/scripts/security/generate-sbom.sh` |
| medium | verification and release governance | 16 | 0 | 16 | `apps/Phoenix-Predict-Combined/scripts/security/jvm-dependency-baseline.sh` |
