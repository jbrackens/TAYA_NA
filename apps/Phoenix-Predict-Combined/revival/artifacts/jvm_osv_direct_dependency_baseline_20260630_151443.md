...
- Generated: `2026-06-30T15:14:43.373Z`
...
|---|---:|---|---|
| `com.lightbend.akka.management:akka-management_2.13` | `1.4.1` | GHSA-9qvj-rpj8-v5c8 | `project/Dependencies.scala:113` |
...
| `ch.qos.logback:logback-classic` | `1.5.37` | `project/Dependencies.scala:152` |
| `com.beachape:enumeratum_2.13` | `1.7.0` | `project/Dependencies.scala:279`, `project/Dependencies.scala:457`, `build.sbt:213` |
...
| `com.github.liancheng:organize-imports_2.13` | `0.6.0` | `project/Dependencies.scala:464` |
...
| `com.lightbend.akka.management:akka-management_2.13` | `1.4.1` | `project/Dependencies.scala:113` |
| `com.lightbend.akka.management:akka-management-cluster-bootstrap_2.13` | `1.4.1` | `project/Dependencies.scala:114` |
| `com.lightbend.akka.management:akka-management-cluster-http_2.13` | `1.4.1` | `project/Dependencies.scala:115` |
...
| `com.typesafe.akka:akka-http_2.13` | `10.4.0` | `project/Dependencies.scala:135`, `project/Dependencies.scala:311` |
| `com.typesafe.akka:akka-http-caching_2.13` | `10.4.0` | `project/Dependencies.scala:136` |
| `com.typesafe.akka:akka-http-jackson_2.13` | `10.4.0` | `project/Dependencies.scala:416` |
| `com.typesafe.akka:akka-http-spray-json_2.13` | `10.4.0` | `project/Dependencies.scala:312`, `project/Dependencies.scala:413` |
| `com.typesafe.akka:akka-http-testkit_2.13` | `10.4.0` | `project/Dependencies.scala:205` |
| `com.typesafe.akka:akka-http-xml_2.13` | `10.4.0` | `project/Dependencies.scala:137`, `project/Dependencies.scala:313` |
| `com.typesafe.akka:akka-http2-support_2.13` | `10.4.0` | `project/Dependencies.scala:417` |
...
| `net.logstash.logback:logstash-logback-encoder` | `8.1` | `project/Dependencies.scala:153` |
...
| `org.slf4j:jcl-over-slf4j` | `2.0.17` | `project/Dependencies.scala:158` |
| `org.slf4j:slf4j-api` | `2.0.17` | `project/Dependencies.scala:155` |
