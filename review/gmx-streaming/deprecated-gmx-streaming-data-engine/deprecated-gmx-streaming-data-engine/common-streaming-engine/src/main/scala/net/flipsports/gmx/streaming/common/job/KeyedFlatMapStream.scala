...
abstract class KeyedFlatMapStream[SOURCE <: SpecificRecord, CONFIG, KEY, TARGET, BRAND](name: String = "Generic Job - Map from A to B", brand: BRAND)(implicit configuration: CONFIG)
  extends Logger
    with KeyedRowFlatMapper[SOURCE, CONFIG, KEY, TARGET, BRAND]
  ...
  def execute(): JobExecutionResult = {
    ...
    val kafkaSink = keyedProducer[KEY, TARGET](keyClass, targetClass, env.getConfig)
