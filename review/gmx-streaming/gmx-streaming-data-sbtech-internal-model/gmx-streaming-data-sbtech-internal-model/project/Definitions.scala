...
object Deps {
  ...
  private val sbtech = Seq(
    ...
    "net.flipsports.gmx.dataapi.sbtech.bet" %% "wallet-transaction" % Versions.externalApi.bets,
    "net.flipsports.gmx.dataapi.sbtech.bet" %% "login" % Versions.externalApi.bets,
    "net.flipsports.gmx.dataapi.sbtech.bet" %% "offer-options" % Versions.externalApi.bets,
    "net.flipsports.gmx.dataapi.sbtech.bet" %% "offer-events" % Versions.externalApi.bets,
