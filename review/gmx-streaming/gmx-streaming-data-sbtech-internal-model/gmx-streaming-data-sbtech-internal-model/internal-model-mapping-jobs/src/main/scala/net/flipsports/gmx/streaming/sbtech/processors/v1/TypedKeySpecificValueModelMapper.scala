...
import net.flipsports.gmx.streaming.sbtech.processors.v1.model.Output
...
class TypedKeySpecificValueModelMapper[K: TypeTag, V <: SpecificRecord, TK <: SpecificRecord, TV <: SpecificRecord]
  (businessParameters: MapperBusinessParameters[K, V, TK, TV], metaParameters: MetaParameters, businessMetaParameters: BusinessMetaParameters, configuration: SbTechConfig)
