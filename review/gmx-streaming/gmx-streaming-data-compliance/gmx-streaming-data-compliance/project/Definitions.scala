...
object Deps {
  ...
  private val internalApi = Seq(
    ...
    "net.flipsports.gmx.dataapi.internal.compliance" %% "validation" % Versions.internalApi.validation
  )

  private val sbtech = Seq(
    "net.flipsports.gmx.dataapi.sbtech.bet" %% "wallet-transaction" % Versions.externalApi.walletTransaction
  )
...
object Versions {
  ...
  object internalApi {
    ...
    val validation = "0.0.5"
  }

  object externalApi {

    val walletTransaction = "2.0.20"
