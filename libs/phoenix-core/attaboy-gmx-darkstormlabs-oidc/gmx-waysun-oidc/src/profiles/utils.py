...
def get_random_display_name():
    ...
    :rtype: str
    """
    adjective = random.choice(adjectives_list).title()  # nosec
    noun = random.choice(nouns_list).title()  # nosec

    suffix = "".join([random.choice(string.digits) for _ in range(10)])  # nosec
