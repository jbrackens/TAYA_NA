...
```xml
can't scan into dest[11]: cannot scan NULL into *string
```
...
```json
{"error":{"message":"can't scan into dest[11]: cannot scan NULL into *string","status":400}}
```
