...
> The services and routes these runbooks operate were never deployed and are now boot-refused outside local development.
...
> non-custodial EVM wallet + Tron-first deposits; see `docs/archive/cashier/README.md`.
