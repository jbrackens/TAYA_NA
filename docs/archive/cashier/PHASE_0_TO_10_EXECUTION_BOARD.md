...
> The phase plan stopped at the points-only pivot; phases 3 onward were never executed and no provider was ever selected.
...
Hard launch blockers are tracked in `docs/archive/cashier/LAUNCH_BLOCKERS.md`.
...
Artifact: `docs/archive/cashier/PROVIDER_SPIKE_TRANSCRIPT_TEMPLATE.md`.
Artifact: `docs/archive/cashier/PROVIDER_SCORECARD.md`.
Artifact: `docs/archive/cashier/SETTLEMENT_CHAIN_SCORECARD.md`.
Artifact: `docs/archive/cashier/WALLET_PROVIDER_SCORECARD.md`.
...
Artifact: `docs/archive/cashier/TESTNET_E2E_ACCEPTANCE.md`.
Artifact: `docs/archive/cashier/MOCK_E2E_TRACE.md`.
...
Artifact: `docs/archive/cashier/RECOVERY_AND_SUPPORT_RUNBOOK.md`.
...
Artifact: `docs/archive/cashier/COMPLIANCE_CONTROLS.md`.
...
Artifact: `docs/archive/cashier/SECURITY_THREAT_MODEL.md`.
Artifact: `docs/archive/cashier/INCIDENT_RESPONSE.md`.
...
Artifact: `docs/archive/cashier/BETA_LAUNCH_AND_RECONCILIATION.md`.
Artifact: `docs/archive/cashier/OBSERVABILITY_AND_CANARIES.md`.
Artifact: `services/cashier-api/observability-events.json`.
