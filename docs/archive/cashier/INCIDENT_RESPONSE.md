...
> There is no money path left to run an incident against — the cashier, crypto and payment routes are unmounted by default.
> See `CLAUDE.md` for current architecture.

# TapTrade Cashier Incident Response

**Status:** SUPERSEDED 2026-09-06 — abandoned workstream (was: "Draft gate for Phase 8-9.").
**Date:** 2026-05-25.
