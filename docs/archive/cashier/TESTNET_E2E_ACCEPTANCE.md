...
> The testnet acceptance run was never performed; no provider or settlement chain was ever selected.
> See `CLAUDE.md` for current architecture.

# TapTrade Cashier Testnet E2E Acceptance

**Status:** SUPERSEDED 2026-09-06 — abandoned workstream (was: "Stage 1 Alpha plus V3 testnet gates.").
**Date:** 2026-05-28.
