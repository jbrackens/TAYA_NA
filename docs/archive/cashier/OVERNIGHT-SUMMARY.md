...
> A point-in-time summary of an overnight build session; the workstream it reports on was later abandoned.
...
> `docs/archive/cashier/README.md` and `docs/archive/cashier/DECISIONS.md` D5.
