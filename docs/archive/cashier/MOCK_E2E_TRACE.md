...
> A credential-free trace of a deposit flow that was never built against a real provider.
> See `CLAUDE.md` for current architecture.

# Mock E2E Trace: Maria TRC-20 Deposit to EVM Withdrawal

**Status:** SUPERSEDED 2026-09-06 — abandoned workstream (was: "Credential-independent trace.").
**Date:** 2026-05-25.
