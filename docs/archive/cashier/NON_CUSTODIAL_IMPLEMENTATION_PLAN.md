...
> Superseded first by the 2026-05-27 custodial decision and then by the points-only launch; no non-custodial cashier was built.
> See `CLAUDE.md` for current architecture.

# TapTrade Cashier — non-custodial implementation kickoff

**Status:** SUPERSEDED 2026-09-06 — abandoned workstream (was: "Kickoff plan.").
...
- [x] Make `docs/archive/cashier/README.md` the non-custodial source of truth.
