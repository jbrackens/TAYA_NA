...
> A log of decisions taken during an overnight build whose workstream was later abandoned for the points-only launch.
...
Updated source of truth: `docs/archive/cashier/README.md`.
