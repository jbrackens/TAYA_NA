...
> No deposit provider was ever selected — the launch product has no deposit rail.
> See `CLAUDE.md` for current architecture.

# ADR-002: Tron Deposit Provider Shortlist

**Status:** SUPERSEDED 2026-09-06 — was "Proposed."; no deposit provider was ever selected and none will be.
**Date:** 2026-05-25.
