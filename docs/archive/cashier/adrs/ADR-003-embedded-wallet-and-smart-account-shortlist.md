...
> No wallet or smart-account provider was ever selected — the launch product has no user wallet on chain.
> See `CLAUDE.md` for current architecture.

# ADR-003: Embedded Wallet and Smart Account Shortlist

**Status:** SUPERSEDED 2026-09-06 — was "Proposed."; no wallet or smart-account provider was ever selected and none will be.
**Date:** 2026-05-25.
