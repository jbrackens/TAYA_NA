...
> No settlement chain was ever selected — the launch product settles nothing on chain.
> See `CLAUDE.md` for current architecture.

# ADR-004: Settlement Chain Shortlist

**Status:** SUPERSEDED 2026-09-06 — was "Proposed."; no settlement chain was ever selected and none will be.
**Date:** 2026-05-25.
