...
> A threat model for a money path that was never shipped; the launch product holds non-redeemable points only.
> See `CLAUDE.md` for current architecture.

# TapTrade Cashier Security Threat Model

**Status:** SUPERSEDED 2026-09-06 — abandoned workstream (was: "Draft gate for Phase 8.").
**Date:** 2026-05-25.
