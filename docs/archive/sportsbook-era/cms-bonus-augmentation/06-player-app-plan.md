...
> Sportsbook-era planning from 2026-04-16, superseded by the prediction-market fork the same day and never executed; its code roots (`apps/TapTrade-Sportsbook-Combined/`, `services/codex-prep/`, `docs/legacy-analysis/`) do not exist. See the [README](./README.md) in this directory.
> See `CLAUDE.md` for current architecture.

> Historical sportsbook-era note: this April 2026 plan predates the TapTrade
