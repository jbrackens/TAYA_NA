...
> It records a component/sample-data pass over back-office pages that no longer exist (`/trading`
> with fixture boards and odds adjustment, bet and live-match widgets); the sportsbook domain was
> dropped and the office now administers prediction markets.
