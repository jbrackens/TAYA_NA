...
> A sportsbook-era session summary of the back-office error/loading pass; the shared components it
> lists still exist under `office/app/components/shared/`, but the pages and the follow-up phases it
> describes were superseded by the prediction-admin App Router routes.
