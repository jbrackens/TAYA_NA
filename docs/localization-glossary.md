...
| Liquidity | Available money/depth in a market. |
...
| Wallet | User balance/payment container. |
| Connect Wallet | Action to link a wallet. |
| Stake | Amount the user risks or commits. |
| Payout | Amount the user may receive. |
...
- Financial, wallet, and responsible-gaming language should remain precise.
