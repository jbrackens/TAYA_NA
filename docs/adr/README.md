...
Remediation ADRs from the production-readiness audit (2026-05-22) of the Taya NA Predict / "Hula Na!" prediction exchange. Each ADR is grounded in specific files/line numbers in `apps/Phoenix-Predict-Combined`.
