...
DEFAULT_FILE_STORAGE = config('DJANGO_DEFAULT_FILE_STORAGE', default='storages.backends.sftpstorage.SFTPStorage')
...
if USE_BOTO_S3_AS_STORAGE:
    ...
    AWS_S3_HOST = config('DJANGO_AWS_S3_HOST', default='s3.amazonaws.com')
    ...
    STATICFILES_STORAGE = 'project.storage.SFTPStorageStaticFiles'
