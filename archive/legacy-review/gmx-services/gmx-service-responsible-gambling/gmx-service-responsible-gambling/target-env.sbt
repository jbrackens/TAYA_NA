 ...
 */
ThisBuild / cloudflowDockerRegistry := Some("461765575148.dkr.ecr.eu-west-1.amazonaws.com")
ThisBuild / cloudflowDockerRepository := Some("gmx-service-responsible-gambling")
