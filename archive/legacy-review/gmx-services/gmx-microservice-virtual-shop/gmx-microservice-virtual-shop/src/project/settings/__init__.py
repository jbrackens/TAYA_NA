...
AVRO_SCHEMA_BASE_DIR = os.path.join(BASE_DIR, "avro", "virtual_shop")
SLACK_NOTIFICATION_METHOD = config("SLACK_NOTIFICATION_METHOD", default="SLACK")
SLACK_GMX_VIRTUAL_SHOP_NOTIFICATION_CHANNEL = config(
    "SLACK_GMX_VIRTUAL_SHOP_NOTIFICATION_CHANNEL", default="@gmx-virtual-store-purchase"
)
