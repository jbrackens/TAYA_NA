...
Class.Methods =
{
	addMethods: function(source)
	{
		...
		for (var i = 0, length = properties.length; i < length; i++)
		{
			...
			{
				var method = value;
				value = Object.extend((function(m) { return function() { return ancestor[m].apply(this, arguments) };})(property).wrap(method),
				{
...
var Enumerable =
{
	...
	{
		iterator = iterator.bind(context);
		return this.map(function(value, index) {return {value: value, criteria: iterator(value, index)};}).sort(function(left, right)
		{
