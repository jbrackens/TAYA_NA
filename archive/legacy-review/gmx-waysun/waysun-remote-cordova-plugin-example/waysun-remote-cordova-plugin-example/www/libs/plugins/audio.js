...
AudioPlayer.prototype.play = function(file, loop)
{
	...
	if(AudioMixer.isWebAudioSupport())
	{
		...
		{
			if(self.audioWrapper.buffer) return;
...
AudioPlayer.prototype.resume = function()
{
	if(AudioMixer.isWebAudioSupport())
	{
		if(this.audioWrapper)
		{
			try {this.audioWrapper.connect(this.gainNode);}
			catch (e) {};
		}
	}
	else
...
{
    if(!AudioMixer.AUTO_PAUSE_ON_TAB_HIDE) return;
...
AudioMixer.AUTO_PAUSE_ON_TAB_HIDE = true;