...
output "public_vswitch_ids" {
  ...
  value       = alicloud_vswitch.public_vswitches.*.id
}

output "availability_zones" {
  description = "Deprecated and use this_availability_zones instead"
  value       = alicloud_vswitch.public_vswitches.*.availability_zone
}
...
output "this_public_vswitch_ids" {
  description = "List of public vswitch ids"
  value       = alicloud_vswitch.public_vswitches.*.id
}

output "this_public_vswitch_names" {
  description = "List of public vswitch names"
  value       = alicloud_vswitch.public_vswitches.*.name
}

output "this_public_vswitch_cidr_blocks" {
  description = "The public vswitch cidr block"
  value       = alicloud_vswitch.public_vswitches.*.cidr_block
}

output "this_public_vswitch_tags" {
  description = "List of public vswitch tags."
  value       = alicloud_vswitch.public_vswitches.*.tags
}
