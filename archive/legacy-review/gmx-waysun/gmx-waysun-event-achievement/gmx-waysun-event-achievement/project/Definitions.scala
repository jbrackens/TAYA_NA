...
object Deps {
  ...
  private val externalApi = Seq(
    "stella" %% "achievement-events" % Versions.externalApi.waysunDataApi,
    "stella" %% "aggregation-results" % Versions.externalApi.waysunDataApi,
    "stella" %% "achievement-rule-configurations" % Versions.externalApi.waysunDataApi)
...
object Versions {
  ...
  object internalApi {
    ...
    val streamingEngine = "0.0.46"

  }

  object externalApi {

    val waysunDataApi = "0.0.37"
  }
