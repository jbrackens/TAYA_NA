...
object OrderByFilters {
  ...
  val description: String = {
    ...
    val exampleFilterWithSign = s"${OrderByDirection.Desc.entryName}_${OrderByType.FieldValue.entryName}"
    val exampleFilterWithSign2 = s"${OrderByDirection.Asc.entryName}_${OrderByType.AchievementDate.entryName}"
...
object OrderByType extends Enum[OrderByType] with PlayJsonEnum[OrderByType] {
  ...
  case object AchievementDate extends OrderByType
