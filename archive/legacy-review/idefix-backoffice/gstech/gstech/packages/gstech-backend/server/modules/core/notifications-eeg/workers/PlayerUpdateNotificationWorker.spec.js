/* @flow */
const PlayerUpdateNotificationWorker = require('./PlayerUpdateNotificationWorker');
const { players: { testPlayer } } = require('../../../../../scripts/utils/db-data');
const Player = require('../../../players/Player');
const { events } = require('../self-consumer');

describe('EEG PlayerUpdateNotificationWorker tests', () => {
  let player:
    | {
  ...
  it('can notify PlayerUpdateNotificationWorker', async () => {
    const job: any = {
      data: { player },
    };
    const result = await PlayerUpdateNotificationWorker.handleJob(job);
