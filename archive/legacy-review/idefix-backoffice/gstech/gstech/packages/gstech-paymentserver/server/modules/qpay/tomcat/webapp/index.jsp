...
<BODY>
<form class="form-horizontal" action="sendRequest.jsp" method="post">
               ...
               <div class="row">
                 <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select class="form-control" id="ag_id" name="ag_id">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="me_id" id="me_id" value="" />
                      </div>
                    </div>
                  </div>
                </div><?php */?>
                <div class="row">
                  <?php /*?><div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="me_key" id="me_key" value="" />
                      </div>
                    </div>
                  </div><?php */?>
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="order_no" id="order_no" value="12345" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="success_url" id="success_url" value="http://localhost:8080/ag-java-plugin/MerchantSuccess.jsp">
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8"> 
                        <input type="text" class="form-control" name="failure_url" id="failure_url" value="http://localhost:8080/ag-java-plugin/MerchantFailure.jsp">
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                      <input type="text"  id="card_no" name="card_no"  class="form-control" value="">
