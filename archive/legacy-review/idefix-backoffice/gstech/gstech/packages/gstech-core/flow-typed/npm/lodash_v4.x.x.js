...
declare module "lodash" {
  ...
  declare type Lodash = {
    ...
    // Lang
    castArray: <T>(value: T) => T extends Array<any> ? T : Array<T>;
    clone<T>(value: T): T;
    ...
    flow: typeof $ComposeReverse & ((...funcs: $ReadOnlyArray<Function>) => Function);
    flowRight: typeof $Compose & ((...funcs: $ReadOnlyArray<Function>) => Function);
...
declare module "lodash/fp" {
  ...
  declare type Lodash = {
    ...
    defaultTo:
      ...
      & (<T1: number, T2>(defaultValue: T2, value: T1) => T1 | T2);
    flow: typeof $ComposeReverse & ((...funcs: $ReadOnlyArray<Function>) => Function);
    pipe: typeof $ComposeReverse & ((...funcs: $ReadOnlyArray<Function>) => Function);
    flowRight: typeof $Compose & ((...funcs: $ReadOnlyArray<Function>) => Function);
    compose: typeof $Compose & ((...funcs: $ReadOnlyArray<Function>) => Function);
    identity<T>(value: T): T;
    iteratee(func: any): Function;
    matches:
      & ((source: Object) => ((object: Object) => boolean))
