...
declare type ExpectChain<T = any> = {
  and: ExpectChain<T>,
  at: ExpectChain<T>,
  be: ExpectChain<T>,
  been: ExpectChain<T>,
  ...
  eq: (value: any, message?: string) => ExpectChain<T>,
  eql: (value: any, message?: string) => ExpectChain<T>,
  equal: (value: any, message?: string) => ExpectChain<T>,
  equals: (value: any, message?: string) => ExpectChain<T>,
  ...
  lengthOf: ExpectChain<number> & ((value: number, message?: string) => ExpectChain<T>),
  ...
  // chai-subset
  containSubset: (value: mixed) => ExpectChain<T>,
  // chai-redux-mock-store
  dispatchedActions: (actions: Array<{ ... } | ((action: { ... }) => any)>) => ExpectChain<T>,
  ...
  equalInAnyOrder: (expected: { ... } | Array<mixed> ) => ExpectChain<T>,
  // chai-datetime
  closeToTime: (expected: Date, delta: number) => ExpectChain<T>,
  equalTime: (expected: Date) => ExpectChain<T>,
  beforeTime: (expected: Date) => ExpectChain<T>,
  beforeOrEqualTime: (expected: Date) => ExpectChain<T>,
  afterTime: (expected: Date) => ExpectChain<T>,
  afterOrEqualTime: (expected: Date) => ExpectChain<T>,
  withinTime: (expected: Date) => ExpectChain<T>,
  equalDate: (expected: Date) => ExpectChain<T>,
  beforeDate: (expected: Date) => ExpectChain<T>,
  beforeOrEqualDate: (expected: Date) => ExpectChain<T>,
  afterDate: (expected: Date) => ExpectChain<T>,
  afterOrEqualDate: (expected: Date) => ExpectChain<T>,
  withinDate: (expected: Date) => ExpectChain<T>,
  ...
};

declare var Chai$Expect: {
