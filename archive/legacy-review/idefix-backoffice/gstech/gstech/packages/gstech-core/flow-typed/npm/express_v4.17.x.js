...
declare type express$RequestContext = { [param: string]: any, ... };
declare type express$Session = { [param: string]: any, ... };
...
// Can't import Player here. Not comlpete type definition, but it's better than nothing.
...
declare class express$Request extends http$IncomingMessage mixins express$RequestResponseBase {
  baseUrl: string;
  body: any; // TODO: narrow this down - (should be 'mixed')
  ...
  campaign: {
    id: Id,
    status: 'draft' | 'active' | 'running' | 'archived',
    startTime: Date,
    name: string,
  },
  campaignGroup: {
...
declare type express$NextFunction = (err?: ?Error | "route" | string) => mixed;
declare type express$Middleware<
  Req: express$Request = express$Request,
  Res: express$Response = express$Response,
> =
  | ((req: Req, res: Res) => mixed)
