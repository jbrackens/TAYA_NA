// flow-typed signature: d655a2355cf44398db5feb6b3c348b1c
// flow-typed version: 185bba0aeb/@faker-js/faker_v7.x.x/flow_>=v0.83.x
...
declare module '@faker-js/faker' {
  ...
  declare type HTTPStatusCodeType =
    | 'informational'
    | 'success'
    | 'clientError'
    | 'serverError'
  ...
  declare type SexType = 'female' | 'male';
  declare type GenderType = SexType;

  declare type FullNameOptions = {
    firstName?: string,
    lastName?: string,
    sex?: SexType,
  };
  declare type CardinalDirectionOptions = {
    abbreviated?: boolean,
  };

  declare type CoordinateOptions = {
    max?: number,
    min?: number,
    precision?: number,
  };

  declare type NearbyGPSOptions = {
  ...
  declare type DisplayNameOptions = {
    firstName?: string,
    lastName?: string,
  };
  ...
  declare type Faker = {
    ...
    seed: ((seed?: number) => number) | ((seedArray: Array<number>) => Array<number>),
    /**
    ...
    color: {
      cmyk: (options?: { format?: ColorFormat }) => string | Array<number>,
      ...
      hsl: (options?: { format?: ColorFormat, includeAlpha?: boolean }) => string | Array<number>,
      human: () => string,
      hwb: (options?: { format?: ColorFormat }) => string | Array<number>,
      lab: (options?: { format?: ColorFormat }) => string | Array<number>,
      lch: (options?: { format?: ColorFormat }) => string | Array<number>,
      rgb: (options?: {
        casing?: Casing,
    ...
    git: {
      branch: () => string,
      commitEntry: (options?: { eol?: 'CRLF' | 'LF', merge?: boolean }) => string,
    ...
    internet: {
      ...
      displayName: (options?: DisplayNameOptions) => string,
      userName: (options?: DisplayNameOptions) => string,
      domainName: () => string,
      domainWord: () => string,
      domainSuffix: () => string,
      ...
      httpStatusCode: (options?: { types?: Array<string> }) => number,
      emoji: (options?: { types?: Array<string> }) => string,
      port: () => number,
      protocol: () => 'http' | 'https',
    },
    location: {
      buildingNumber: () => string,
      cardinalDirection: (options?: CardinalDirectionOptions) => string,
      city: () => string,
      country: () => string,
      countryCode: (variant?: 'alpha-2' | 'alpha-3' | 'numeric') => string,
      county: () => string,
      direction: (options?: CardinalDirectionOptions) => string,
      latitude: (options?: CoordinateOptions) => number,
      longitude: (options?: CoordinateOptions) => number,
      nearbyGPSCoordinate: (options?: NearbyGPSOptions) => [number, number],
      ordinalDirection: (options?: CardinalDirectionOptions) => string,
      secondaryAddress: () => string,
