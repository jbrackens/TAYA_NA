...
declare type $winstonLogger<T: $winstonLevels> = {
  ...
  profile: (name: string, info?: Partial<$winstonInfo<T>>) => void,
  ...
};
...
declare type $winstonDefaultLogger = $winstonLogger<$winstonLevels>;
...
declare interface $winstonProfiler<T: $winstonNpmLogLevels> {
  ...
  start: Date;
  done(info?: Partial<$winstonInfo<T>>): void;
};
