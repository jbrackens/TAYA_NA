// flow-typed signature: bf709a6f2f03d9e4d2dd60d84344aa4c
// flow-typed version: <<STUB>>/supertest_v^6.1.3/flow_v0.154.0
...
declare type superagent$Response = {
  ...
  headers: { [key: string]: string, 'set-cookie': string[] },
...
// declare type MultipartValueSingle = Blob | Buffer | fs$ReadStream | string | boolean | number;
declare type MultipartValueSingle = Blob | Buffer | string | boolean | number;

declare type MultipartValue = MultipartValueSingle | MultipartValueSingle[];

declare type superagent$CallbackHandler = (err: any, res: superagent$Response) => mixed;
...
declare type superagent$Parser = superagent$BrowserParser | superagent$NodeParser;
...
declare class superagent$Request extends Promise<superagent$Response> {
  ...
  on(name: 'progress', handler: (event: superagent$ProgressEvent) => void): this;
  on(name: 'response', handler: (response: superagent$Response) => void): this;
  ...
  send(data?: string | { ... } | Array<{ ... }>): this;
  serialize(serializer: (any) => string): this;
  set(field: { ... }): this;
  set(field: string, val: string | number): this;
...
declare class supertest$Test extends superagent$Request {
  constructor(app: http$Server | string, method: string, path: string, host?: string): this;
  ...
  // ! this breaks inference in all our tests, supertest$BodyAssertion probably needs refinement
  // expect(body: supertest$BodyAssertion, callback?: superagent$CallbackHandler): this;

  // Queue a header assertion
  expect(field: string, val: string | number | RegExp, callback?: superagent$CallbackHandler): this;
...
declare module 'supertest' {
  ...
  declare module.exports: {
    ...
    Test: supertest$Test,
    agent: any, // TODO implement a proper supertest$agent
  };
}
