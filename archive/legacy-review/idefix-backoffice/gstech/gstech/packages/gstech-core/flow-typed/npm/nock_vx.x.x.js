// flow-typed signature: 9fc6d421c98604c2cc5e150902fe2267
// flow-typed version: c6154227d1/nock_v9.x.x/flow_>=v0.104.x
...
declare class $npm$nock$Nock {
  ...
  static removeInterceptor(
    interceptor: $npm$nock$Nock | Partial<$npm$nock$InterceptorOptions>,
  ): void;
  ...
  reply(
    code: number,
    data?: ((uri: string, body: mixed, cb: (error: ?Error, result: mixed) => any) => mixed) | mixed,
    header?: Object,
  ): this;
