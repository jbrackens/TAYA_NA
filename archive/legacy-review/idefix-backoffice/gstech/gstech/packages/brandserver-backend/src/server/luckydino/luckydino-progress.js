...
const getMeterStates = async (journey: Journey): Promise<?DinoMeterStates> => {
  ...
  logger.debug('getMeterStates', { username: journey.req.user.username, rs, progresses, progress, count });
