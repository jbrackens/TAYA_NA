// flow-typed signature: c60e27ef6c13739d990ff6dfe728492a
// flow-typed version: c6154227d1/knex_v0.16.x/flow_>=v0.104.x

declare class Knex$Transaction<R>
  mixins Knex$QueryBuilder<R>, events$EventEmitter, Promise<R> {
  [[call]]: (tableName: string|Knex$Raw<R>) => Knex$QueryBuilder<R>;
...
declare class Knex$QueryBuilder<R> mixins Promise<R> {
  ...
  select(...key: string[]): this;
  select(...keys: Knex$Raw<R>[]): this;
  select(...key: Array<string|Knex$QueryBuilder<R>|Knex$Raw<R>>): this;
  ...
  whereRaw(sql: string, ...values: any): this;
  ...
  leftJoin(table: string|Knex$Raw<R>|Knex$QueryBuilder<R>, c1: string|Knex$Raw<R>, c2: string|Knex$Raw<R>): this;
  leftJoin(builder: Knex$QueryBuilder<R>): this;
  leftJoin(table: string, builder: Knex$QueryBuilderFn<R>): this;
  leftJoin(table: string|Knex$Raw<R>|Knex$QueryBuilder<R>, onFunction: () => void): this;
  ...
  first(...key: string[]): this;
  clone(): this;
  modify(builder: Knex$QueryBuilderFn<R>): this;
  modify(
  ...
  from(
    fn: (queryBuilder: Knex$QueryBuilder<R>) => Knex$QueryBuilder<R>,
  ): this;
