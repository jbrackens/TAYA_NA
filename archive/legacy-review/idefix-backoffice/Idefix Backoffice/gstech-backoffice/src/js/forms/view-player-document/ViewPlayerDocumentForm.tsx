...
import KycDocument from "../formik-fields/KycDocumentField";
...
const ViewPlayerDocumentForm = ({ accounts, formikProps: { values } }: Props) => {
  ...
  return (
    <Box component={Form} display="flex" flexDirection="column">
      ...
      <Field name="documentType" component={ButtonGroup} buttons={DOCUMENT_TYPE_BUTTONS} />
      {photoId == null && (content == null || content === "") && (
        <Field name="type" component={ButtonGroup} buttons={TYPE_BUTTONS} />
      )}
      {type === "photo" && <Field name="photoId" component={KycDocument} fileName={name} />}
      ...
      <Field name="expiryDate" label="Set document expiry date" component={DatePicker} />
...
export default ViewPlayerDocumentForm;
