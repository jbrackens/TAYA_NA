...
import EditableImage from "../../modules/kyc-process/components/EditableImage";
import { Kyc, PlayerAccount } from "app/types";
...
const KycProcess = ({ formikProps, document, accounts, onEditImage }: Props) => {
    ...
    <Form>
      ...
      <Box display="flex" flexDirection="column" mt={3}>
        ...
        <Box mt={3}>
          ...
          <Field name="documentType" component={ButtonGroup} buttons={TYPE_BUTTONS} onClick={onChangeDocumentType} />
        </Box>

        {documentType && documentType !== "other" && documentType !== "payment_method" && (
          <Box alignSelf="flex-start" width="330px">
            <Field name="expiryDate" label="Enter document expiry date if applicable" component={DatePicker} />
          </Box>
        )}
