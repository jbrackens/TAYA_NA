...
export default (fetchApi: FetchApi): PlayersAPI => ({
  ...
  getTicket: externalRoundId => fetchApi(`${PREFIX}/tickets/${externalRoundId}`),
  getTransactions: (playerId, params) => fetchApi(`${PREFIX}/player/${playerId}/transactions`, { params }),
  getTransactionDates: playerId => fetchApi(`${PREFIX}/player/${playerId}/transaction-dates`),
  getPaymentTransactions: (playerId, { ...params }) => fetchApi(`${PREFIX}/player/${playerId}/payments`, { params }),
