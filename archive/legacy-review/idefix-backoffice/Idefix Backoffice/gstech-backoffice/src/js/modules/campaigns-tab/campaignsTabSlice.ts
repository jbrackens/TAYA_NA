...
export const getIsLoading = createSelector(getCampaignsTab, state => state.isLoading);
export const getCampaigns = createSelector(getCampaignsTab, state => state.campaigns);

export const getIsActiveCampaignsLoading = createSelector(getCampaignsTab, state => state.isActiveCampaignsLoading);
