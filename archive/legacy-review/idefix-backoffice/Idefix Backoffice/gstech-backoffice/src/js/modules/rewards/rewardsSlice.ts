...
import { RewardInitialGroups, RewardProgress } from "app/types";
...
>("rewards/fetch-ledgers", async ({ playerId, params = {} }, { dispatch }) => {
...
export const fetchInitGroups = createAsyncThunk("rewards/fetch-init-groups", async () => {
  try {
