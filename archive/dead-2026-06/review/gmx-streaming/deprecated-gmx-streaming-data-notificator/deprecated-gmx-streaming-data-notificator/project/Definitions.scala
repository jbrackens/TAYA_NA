...
object Deps {
  ...
  private val internalApi = Seq(
    ...
    "net.flipsports.gmx.dataapi.internal.notificator" %% "notifications" % Versions.internalApi.notificator
  )
  ...
  val notificationJobs: Seq[ModuleID] = flink ++
    kafka ++
    flinkKafka ++
    flinkMetrics ++
    common ++
...
object Versions {
  ...
  object internalApi {
    ...
    val streamingEngine = "0.0.18"

    val notificator = "0.0.8"
  }

  object externalApi {

    val customerDetails = "2.0.8"
  }
