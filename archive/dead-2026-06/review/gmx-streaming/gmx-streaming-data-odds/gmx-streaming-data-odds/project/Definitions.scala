...
object Deps {
  ...
  private val internalApi = Seq(
    ...
    "net.flipsports.gmx.dataapi.internal.racingroulette" %% "events" % Versions.internalApi.racingRouletteApi,
    "gmx.dataapi.internal" %% "site-extensions" % Versions.internalApi.siteExtensionsApi
  )
  private val sbtech = Seq(
    "net.flipsports.gmx.dataapi.sbtech.odds" %% "markets" % Versions.externalApi.odds,
    "net.flipsports.gmx.dataapi.sbtech.odds" %% "seletions" % Versions.externalApi.odds,
    "net.flipsports.gmx.dataapi.sbtech.odds" %% "events" % Versions.externalApi.odds
  )
  ...
  val streaminDependencies: Seq[ModuleID] = flink ++
      kafka ++
      flinkKafka ++
      flinkMetrics ++
      common ++
...
object Versions {
  ...
  object internalApi {
    ...
    val streamingEngine = "0.0.41"

    val racingRouletteApi = "0.0.20"

    val siteExtensionsApi = "0.2.4"
  }
