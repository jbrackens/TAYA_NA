  ...
  return (
    <>
      <CoreModal
        ...
        maskClosable={false}
      >
        {/* // hiding sign up form and add message due to vie.gg shut down */}
        <div style={{ color: "#8d8d8d" }}>
          ...
          log in to close your account. Any accounts remaining open at that date
          will automatically be closed and any remaining balances of $1 or more
          will be returned by check sent to the address registered on the
          applicable account.
          <br /> <br />
