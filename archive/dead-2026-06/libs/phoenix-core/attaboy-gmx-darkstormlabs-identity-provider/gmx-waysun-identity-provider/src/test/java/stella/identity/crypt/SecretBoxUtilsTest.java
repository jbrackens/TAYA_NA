...
public class SecretBoxUtilsTest {

  private static final String HEX_KEY = "ea87def016584b3c84e5cdbea4dcc868ea87def016584b3c84e5cdbea4dcc868";

  private static final String ENCRYPTED_TEST_SECRET_BOX = "megs0X7eHgike-J13ayuSgOCT9PxxakFIt0LpnWishbo4KOJ" +
      "yqcizGplfl32PtFUHZaE3N7UbS9-NxFokmtERK" +
  ...
  private static final String DECRYPTED_TEST_SECRET_BOX = "{\"orig\": \"117ba0aa-fe0c-43b1-ab60-851391e96b44\", \"jpk\": " +
  ...
  @Test
  public void testDecrypt() throws SecretBoxUtils.SecretBoxDecryptionException {
    SecretBoxUtils utils = new SecretBoxUtils();
    assertThat(utils.decrypt(ENCRYPTED_TEST_SECRET_BOX, HEX_KEY), is(DECRYPTED_TEST_SECRET_BOX));
  }

  @Test
  public void testEncrypt() throws SecretBoxUtils.SecretBoxDecryptionException, SecretBoxUtils.SecretBoxEncryptionException {
    SecretBoxUtils utils = new SecretBoxUtils();
    String secretBox = utils.encrypt(DECRYPTED_TEST_SECRET_BOX, HEX_KEY);
    // encryption result is different for each call so we can't just compare with ENCRYPTED_TEST_SECRET_BOX
    assertThat(secretBox, is(not(DECRYPTED_TEST_SECRET_BOX)));
    assertThat(utils.decrypt(secretBox, HEX_KEY), is(DECRYPTED_TEST_SECRET_BOX));
  }
}
