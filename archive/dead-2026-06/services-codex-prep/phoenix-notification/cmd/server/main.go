...
import (
	...
	"github.com/phoenixbot/phoenix-notification/internal/config"
	"github.com/phoenixbot/phoenix-notification/internal/handlers"
...
func main() {
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Put("/notifications/{notificationID}/status", h.UpdateNotificationStatus)
		r.Get("/users/{userID}/notification-preferences", h.GetPreferences)
		r.Put("/users/{userID}/notification-preferences", h.UpdatePreferences)
	...
	go func() {
		logger.Info("starting phoenix-notification", slog.Int("port", cfg.Port))
